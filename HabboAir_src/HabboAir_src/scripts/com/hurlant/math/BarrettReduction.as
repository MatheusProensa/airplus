package com.hurlant.math
{
   ...
   internal class BarrettReduction implements IReduction
   {
      ...
      private var UnknownVarFromBarrettReduction_BigInteger_1:BigInteger;
      ...
      public function BarrettReduction(param1:BigInteger)
      {
         ...
         r2 = new BigInteger();
         q3 = new BigInteger();
         BigInteger.UnknownConstFromBigInteger_BigInteger_1.bi_internal::dlShiftTo(2 * param1.t,r2);
         UnknownVarFromBarrettReduction_BigInteger_1 = r2.divide(param1);
         this.m = param1;
      }
      ...
      public function reduce(param1:BigInteger) : void
      {
         ...
         UnknownVarFromBarrettReduction_BigInteger_1.bi_internal::multiplyUpperTo(r2,m.t + 1,q3);
