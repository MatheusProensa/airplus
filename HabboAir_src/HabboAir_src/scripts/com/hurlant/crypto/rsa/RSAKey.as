package com.hurlant.crypto.rsa
{
   ...
   public class RSAKey
   {
      ...
      public var UnknownVarFromRSAKey_BigInteger_1:BigInteger;
      ...
      public function RSAKey(param1:BigInteger, param2:int, param3:BigInteger = null, param4:BigInteger = null, param5:BigInteger = null, param6:BigInteger = null, param7:BigInteger = null, param8:BigInteger = null)
      {
         ...
         this.dmp1 = param6;
         this.dmq1 = param7;
         this.UnknownVarFromRSAKey_BigInteger_1 = param8;
      ...
      public static function generate(param1:uint, param2:String) : RSAKey
      {
         ...
         do
         {
            ...
            while(!(_loc10_.p.subtract(BigInteger.UnknownConstFromBigInteger_BigInteger_1).gcd(_loc3_).compareTo(BigInteger.UnknownConstFromBigInteger_BigInteger_1) == 0 && _loc10_.p.isProbablePrime(10)));
            
            do
            {
               _loc10_.q = bigRandom(_loc7_,_loc9_);
            }
            while(!(_loc10_.q.subtract(BigInteger.UnknownConstFromBigInteger_BigInteger_1).gcd(_loc3_).compareTo(BigInteger.UnknownConstFromBigInteger_BigInteger_1) == 0 && _loc10_.q.isProbablePrime(10)));
            ...
            _loc6_ = _loc10_.p.subtract(BigInteger.UnknownConstFromBigInteger_BigInteger_1);
            _loc4_ = _loc10_.q.subtract(BigInteger.UnknownConstFromBigInteger_BigInteger_1);
         }
         while(_loc5_ = _loc6_.multiply(_loc4_), _loc5_.gcd(_loc3_).compareTo(BigInteger.UnknownConstFromBigInteger_BigInteger_1) != 0);
         ...
         _loc10_.UnknownVarFromRSAKey_BigInteger_1 = _loc10_.q.modInverse(_loc10_.p);
         _loc10_.canEncrypt = _loc10_.n != null && _loc10_.e != 0;
         _loc10_.canDecrypt = _loc10_.canEncrypt && _loc10_.d != null;
         return _loc10_;
      }
      ...
      private function _encrypt(param1:Function, param2:ByteArray, param3:ByteArray, param4:uint, param5:Function, param6:int) : void
      {
         ...
         while(param2.position < _loc10_)
         {
            ...
            _loc7_ = _loc9_ - Math.ceil(_loc8_.bitLength() / 8);
            while(_loc7_ > 0)
            {
               param3.writeByte(0);
               _loc7_--;
      ...
      public function dump() : String
      {
         ...
         if(canDecrypt)
         {
            ...
            if(p != null && q != null)
            {
               ...
               _loc1_ += "IQMP=" + UnknownVarFromRSAKey_BigInteger_1.toString(16) + "\n";
            }
         }
         return _loc1_;
      }
      ...
      protected function doPrivate2(param1:BigInteger) : BigInteger
      {
         ...
         return _loc3_.subtract(_loc4_).multiply(UnknownVarFromRSAKey_BigInteger_1).mod(p).multiply(q).add(_loc4_);
      }
      ...
      protected function doPrivate(param1:BigInteger) : BigInteger
      {
         ...
         return _loc2_.subtract(_loc3_).multiply(UnknownVarFromRSAKey_BigInteger_1).mod(p).multiply(q).add(_loc3_);
      }
   }
}
