package com.sulake.room.utils
{
   public class ColorConverter
   {
      ...
      public static function rgbToHSL(param1:uint) : uint
      {
         var _loc10_:Number = (param1 >> 16 & 0xFF) / 255;
         ...
         return uint((_loc7_ << 16) + (_loc12_ << 8) + _loc8_);
      }
      
      public static function hslToRGB(param1:uint) : uint
      {
         ...
         var _loc14_:Number = (param1 >> 8 & 0xFF) / 255;
         ...
         return uint((_loc13_ << 16) + (_loc4_ << 8) + _loc2_);
      }
      
      public static function rgb2xyz(param1:int) : IVector3d
      {
         var _loc2_:Number = (param1 >> 16 & 0xFF) / 255;
         var _loc4_:Number = (param1 >> 8 & 0xFF) / 255;
         var _loc3_:Number = (param1 >> 0 & 0xFF) / 255;
         if(_loc2_ > 0.04045)
         {
