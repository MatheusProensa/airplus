package com.sulake.air
{
   ...
   public class FileProxy implements UnknownICoreUtils1
   {
      ...
      private static var UnknownVarFromFileProxy_Int_1:int = 0;
      
      private var UnknownVarFromFileProxy_Dictionary_1:Dictionary;
      ...
      private static function resolveFileFromLocalPath(param1:String) : String
      {
         ...
         var _loc2_:int = int(param1.indexOf("local_include/"));
         if(_loc2_ != -1)
         {
      ...
      {
         UnknownVarFromFileProxy_Dictionary_1 = null;
      }
      ...
      public function readCache(param1:String) : ByteArray
      {
         ...
         try
         {
            ...
            Logger.log("[FileProxy] Read file " + _loc2_.nativePath);
         ...
         {
            Logger.log("[FileProxy] File reading error: " + e);
         }
         return null;
      }
      ...
      public function readCacheAsync(param1:String, param2:Function) : void
      {
         ...
         try
         {
            ...
            Logger.log("[FileProxy] Read file " + file.nativePath);
      ...
      public function writeCache(param1:String, param2:ByteArray) : void
      {
         ...
         try
         {
            ...
            _loc4_.close();
            Logger.log("[FileProxy] Wrote file " + _loc3_.nativePath);
         }
         catch(e:Error)
         {
            Logger.log("[FileProxy] File writing error: " + e);
         }
      }
      ...
      public function deleteCacheDirectory(param1:String) : void
      {
         ...
         try
         {
            ...
            if(_loc2_.exists && Boolean(_loc2_.isDirectory))
            {
               ...
               Logger.log("[FileProxy] Deleted directory " + _loc2_.nativePath);
            }
         }
         catch(e:Error)
         {
            Logger.log("[FileProxy] File deleting error: " + e);
         }
      }
      ...
      private function onLocalFileError(param1:Event) : void
      {
         ...
         Logger.log("[FileProxy] Error when accessing local file! " + _loc3_);
         doCallbacks(_loc2_,null);
      }
      
      private function addCallback(param1:String, param2:Function) : void
      {
         if(!UnknownVarFromFileProxy_Dictionary_1)
         {
            UnknownVarFromFileProxy_Dictionary_1 = new Dictionary();
         }
         var _loc3_:Array = UnknownVarFromFileProxy_Dictionary_1[param1];
         if(!_loc3_)
         {
            _loc3_ = [];
            UnknownVarFromFileProxy_Dictionary_1[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      private function doCallbacks(param1:String, param2:BitmapData) : void
      {
         ...
         var _loc4_:Array = UnknownVarFromFileProxy_Dictionary_1[param1];
         if(!_loc4_)
         {
            return;
         }
         ...
         delete UnknownVarFromFileProxy_Dictionary_1[param1];
      }
      ...
      public function swapObjectToDisk(param1:Object) : int
      {
         ...
         try
         {
            if(File.cacheDirectory)
            {
               _loc4_ = ++UnknownVarFromFileProxy_Int_1;
         ...
         {
            Logger.log("[FileProxy] Swap in error: " + e);
            _loc4_ = -1;
         }
         return _loc4_;
      }
      ...
      public function swapObjectFromDisk(param1:int) : Object
      {
         ...
         {
            Logger.log("[FileProxy] Swap out error: " + e);
         }
         return null;
      }
   }
