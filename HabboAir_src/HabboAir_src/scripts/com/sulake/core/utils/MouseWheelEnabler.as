package com.sulake.core.utils
{
   ...
   public class MouseWheelEnabler
   {
      ...
      public static var eventTimeout:Number = 0;
      ...
      public static function handleExternalMouseEvent(param1:Number, param2:Number) : void
      {
         var _loc4_:* = NaN;
         var _loc3_:uint = uint(getTimer());
         if(eventTimeout <= 0 || _loc3_ >= eventTimeout + lastEventTime)
         {
            if(useRawValues)
            {
               _loc4_ = param1;
