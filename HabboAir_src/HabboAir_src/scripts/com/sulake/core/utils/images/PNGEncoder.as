package com.sulake.core.utils.images
{
   ...
   {
      private static var UnknownVarFromPNGEncoder_Array_1:Array;
      
      private static var UnknownVarFromPNGEncoder_Boolean_1:Boolean = false;
      ...
      private static function writeChunk(param1:ByteArray, param2:uint, param3:ByteArray) : void
      {
         ...
         var _loc9_:* = 0;
         var _loc8_:int = 0;
         if(!UnknownVarFromPNGEncoder_Boolean_1)
         {
            UnknownVarFromPNGEncoder_Boolean_1 = true;
            UnknownVarFromPNGEncoder_Array_1 = [];
            _loc10_ = 0;
            while(_loc10_ < 256)
            {
               _loc5_ = _loc10_;
               ...
               UnknownVarFromPNGEncoder_Array_1[_loc10_] = _loc5_;
               _loc10_++;
            }
         }
         var _loc6_:uint = 0;
         ...
         {
            _loc5_ = uint(UnknownVarFromPNGEncoder_Array_1[(_loc5_ ^ param1.readUnsignedByte()) & 0xFF] ^ uint(_loc5_ >>> 8));
            _loc8_++;
         }
         _loc5_ ^= 4294967295;
