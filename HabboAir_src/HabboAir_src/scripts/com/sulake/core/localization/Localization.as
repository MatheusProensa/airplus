package com.sulake.core.localization
{
   ...
   {
      private var UnknownVarFromLocalization_ICoreLocalizationManager_1:ICoreLocalizationManager;
      ...
      private var UnknownVarFromLocalization_Boolean_1:Boolean = false;
      
      public function Localization(param1:ICoreLocalizationManager, param2:String, param3:String = null)
      {
         super();
         UnknownVarFromLocalization_ICoreLocalizationManager_1 = param1;
         _key = param2;
         _raw = param3;
      }
      ...
      public function registerListener(param1:ILocalizable) : void
      {
         ...
         param1.localization = UnknownVarFromLocalization_ICoreLocalizationManager_1.interpolate(value);
      }
      ...
      {
         var _loc1_:String = UnknownVarFromLocalization_ICoreLocalizationManager_1.interpolate(value);
         if(_listeners)
         {
      ...
      private function fillParameterValues() : String
      {
         ...
         if(_loc5_ != null)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               _loc11_ = _key + "." + _loc3_;
               _loc10_ = UnknownVarFromLocalization_ICoreLocalizationManager_1.getLocalization(_loc11_,_loc3_);
