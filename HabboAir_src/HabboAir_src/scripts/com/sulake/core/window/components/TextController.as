package com.sulake.core.window.components
{
   ...
   {
      private static var ALL_FONTS:Array = Font.enumerateFonts();
      
      private static const REPLACE_RANDOM_CHARS:Array = ["a","B","c","D","e"];
      
      protected static const UnknownConstFromTextController_Dictionary_1:Dictionary = createPropertySetterTable();
      
      private var _overFlowReplace:String = "";
      
      private var _isOverflown:Boolean = false;
      ...
      protected var UnknownVarFromTextController_TextFormat_1:TextFormat;
      
      private var _textStyleName:String;
      
      private var UnknownVarFromTextController_UnknownCoreWindowUtils3_1:UnknownCoreWindowUtils3 = new UnknownCoreWindowUtils3();
      
      protected var _settingRectangle:Boolean;
      
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindowModel, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         _textStyleName = String(param5.getWindowFactory().getThemeManager().getPropertyDefaults(param3).get("text_style"));
      ...
      private static function setAntiAliasType(param1:TextController, param2:String) : void
      {
         ...
         param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1.antiAliasType = param2;
      ...
      private static function setBold(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1.fontWeight = "bold";
      }
      ...
      private static function setFontFace(param1:TextController, param2:String) : void
      {
         ...
         param1.defaultTextFormat = _loc3_;
         param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1.fontFamily = param2;
      }
      ...
      private static function setFontSize(param1:TextController, param2:uint) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1.fontSize = param2;
      }
      ...
      private static function setItalic(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1.fontStyle = param2 ? "italic" : "normal";
      }
      ...
      private static function setKerning(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1.kerning = param2;
      }
      ...
      private static function setTextMarginMap(param1:TextController, param2:Map) : void
      {
         if(param1._margins)
         {
            param1._margins.assign(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         else
         {
            param1._margins = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         param1.refreshTextImage();
      }
      ...
      {
         if(param1._margins && param1._margins.left != param2)
         {
      ...
      {
         if(param1._margins && param1._margins.top != param2)
         {
      ...
      {
         if(param1._margins && param1._margins.right != param2)
         {
      ...
      {
         if(param1._margins && param1._margins.bottom != param2)
         {
      ...
      private static function setSharpness(param1:TextController, param2:Number) : void
      {
         ...
         param1.refreshTextImage();
         param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1.sharpness = param2;
      }
      ...
      private static function setSpacing(param1:TextController, param2:Number) : void
      {
         ...
         param1.setTextFormat(_loc3_);
         param1.defaultTextFormat = _loc4_;
         param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1.letterSpacing = param2;
      }
      
      private static function setMaxLines(param1:TextController, param2:int) : void
      {
         param1._maxLines = param2;
         param1.refreshTextImage();
      }
      ...
      {
         var _loc4_:TextFormat = param1.defaultTextFormat;
         _loc4_.leading = param2;
         var _loc3_:TextFormat = new TextFormat(_loc4_.font,_loc4_.size,_loc4_.color,_loc4_.bold,_loc4_.italic,_loc4_.underline,_loc4_.url,_loc4_.target,_loc4_.align,_loc4_.leftMargin,_loc4_.rightMargin,_loc4_.indent,_loc4_.leading);
         _loc3_.leading = param2;
         param1.setTextFormat(_loc3_);
         param1.defaultTextFormat = _loc4_;
         param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1.leading = param2;
      }
      ...
      private static function setTextColor(param1:TextController, param2:uint) : void
      {
         ...
         param1.refreshTextImage();
         param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1.color = param2;
      }
      
      private static function setTextStyle(param1:TextController, param2:UnknownCoreWindowUtils3) : void
      {
         if(!param1 || !param2)
         {
            return;
         }
         var _loc3_:UnknownCoreWindowUtils3 = TextStyleManager.getStyle(param2.name);
      ...
      private static function setTextStyleString(param1:TextController, param2:String) : void
      {
         ...
         var _loc3_:UnknownCoreWindowUtils3 = TextStyleManager.getStyle(param2);
         if(!_loc3_)
         {
      ...
      private static function setThickness(param1:TextController, param2:Number) : void
      {
         ...
         param1.refreshTextImage();
         param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1.thickness = param2;
      }
      ...
      private static function setUnderline(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1.textDecoration = param2 ? "underline" : "none";
      }
      ...
      protected static function setTextFormatting(param1:TextController) : void
      {
         ...
         var _loc2_:UnknownCoreWindowUtils3 = param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1;
         var _loc5_:UnknownCoreWindowUtils3 = TextStyleManager.getStyle(_loc4_);
         var _loc6_:TextFormat = _loc3_.defaultTextFormat;
         if(!_loc5_)
         {
            _loc5_ = TextStyleManager.getStyle("regular");
         }
         if(!_loc5_.color)
         {
            _loc5_.color = 0;
         ...
         _loc3_.embedFonts = FontEnum.isEmbeddedFont(_loc6_.font);
         _loc3_.defaultTextFormat = _loc6_;
         param1.UnknownVarFromTextController_TextFormat_1 = _loc6_;
      }
      ...
      private static function setEtchingColor(param1:TextController, param2:uint) : void
      {
         ...
         param1.refreshTextImage();
         param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1.etchingColor = param1._etchingColor;
      }
      
      private static function setEtchingPosition(param1:TextController, param2:String) : void
      {
         param1._etchingPosition = param2;
         param1.refreshTextImage();
         param1.UnknownVarFromTextController_UnknownCoreWindowUtils3_1.etchingPosition = param1._etchingPosition;
      }
      ...
      {
         _scrollH = param1;
         _field.scrollH = _scrollH * _field.maxScrollH;
         refreshTextImage();
      }
      ...
      override public function clone() : IWindowModel
      {
         ...
         _loc1_._scrollH = _scrollH;
         _loc1_._scrollV = _scrollV;
         _loc1_._margins = _margins.clone(_loc1_.setTextMargins);
         _loc1_._autoSize = _autoSize;
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         _drawing = true;
         _isOverflown = false;
         _loc16_ = _margins.left + _margins.right;
         var _loc15_:int = _margins.top + _margins.bottom;
         var _loc3_:int = _width - _loc16_;
         var _loc6_:int = _height - _loc15_;
         var _loc2_:int = Math.floor(_field.width) + (_field.border ? 1 : 0);
         var _loc13_:Boolean = false;
         if((_autoSize == "none" || _autoSize == "right") && isOverflowReplaceOn)
         {
            _loc10_ = _field.text;
            if(_field.textHeight + _loc15_ > _loc6_)
            {
               ...
               _loc4_ = _field.getLineOffset(_loc5_);
               _loc17_ = _loc7_ = _loc4_ + _field.getLineLength(_loc5_);
         ...
         if(_loc2_ != _loc3_)
         {
            if(_autoSize == "left")
            {
               setRectangle(_x,_y,_loc2_ + _loc16_,Math.floor(_field.height) + _loc15_);
               _loc13_ = true;
            }
            else if(_autoSize != "right")
            {
               if(_autoSize != "center")
               {
         ...
         if(!_loc13_ && !param1 && UnknownVarFromWindowController_WindowEventDispatcher_1)
         {
            _loc14_ = WindowEvent.allocate("WE_RESIZED",this,null);
            UnknownVarFromWindowController_WindowEventDispatcher_1.dispatchEvent(_loc14_);
            _loc14_.recycle();
         }
      }
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            _margins.dispose();
            _margins = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         if(_autoSize == "left")
         {
            _field.width = _width - _margins.left - _margins.right;
         }
         refreshTextImage();
      }
      ...
      protected function parseVariableSet(param1:XML) : void
      {
         ...
         if(param1 != null)
         {
            ...
            XMLVariableParser.parseVariableList(param1.children(),_loc2_);
            _drawing = true;
            for(_loc4_ in _loc2_)
            {
               _loc3_ = UnknownConstFromTextController_Dictionary_1[_loc4_];
               if(_loc3_ != null)
               {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            _loc3_ = UnknownConstFromTextController_Dictionary_1[_loc2_.key];
            if(_loc3_ != null)
            {
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:UnknownCoreWindowUtils3 = TextStyleManager.getStyle(_textStyleName);
         _loc3_.push(createProperty("always_show_selection",_field.alwaysShowSelection));
         _loc3_.push(new PropertyStruct("antialias_type",_field.antiAliasType,"String",_field.antiAliasType != _loc2_.antiAliasType,UnknownCoreWindowTheme1.ANTIALIAS_TYPE_RANGE));
         _loc3_.push(createProperty("auto_size",_autoSize));
         ...
         _loc3_.push(new PropertyStruct("etching_position",_etchingPosition,"String",_etchingPosition != String(_loc2_.etchingPosition),UnknownCoreWindowTheme1.ETCHING_POSITION_RANGE));
         ...
         var _loc1_:uint = uint(_loc2_.color ?? getDefaultProperty("text_color").value);
         ...
         _loc3_.push(createProperty("margin_left",_margins.left));
         _loc3_.push(createProperty("margin_top",_margins.top));
         _loc3_.push(createProperty("margin_right",_margins.right));
         _loc3_.push(createProperty("margin_bottom",_margins.bottom));
      ...
      {
         UnknownVarFromTextController_UnknownCoreWindowUtils3_1 = new UnknownCoreWindowUtils3();
      }
