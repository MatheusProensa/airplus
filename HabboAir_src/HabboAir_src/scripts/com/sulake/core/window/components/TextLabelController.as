package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      private var UnknownVarFromTextLabelController_TextMargins_1:TextMargins;
      
      private var _textHeight:Number = 0;
      
      private var _textWidth:Number = 0;
      
      private var UnknownVarFromTextLabelController_Boolean_1:Boolean = false;
      
      private var _vertical:Boolean = false;
      
      public function TextLabelController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindowModel, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
      ...
      {
         if(!UnknownVarFromTextLabelController_TextMargins_1)
         {
            UnknownVarFromTextLabelController_TextMargins_1 = new TextMargins(0,0,0,0,setTextMargins);
         }
         return UnknownVarFromTextLabelController_TextMargins_1;
      }
      ...
      {
         return !!UnknownVarFromTextLabelController_TextMargins_1 ? UnknownVarFromTextLabelController_TextMargins_1.left : 0;
      }
      
      public function get drawOffsetY() : int
      {
         return !!UnknownVarFromTextLabelController_TextMargins_1 ? UnknownVarFromTextLabelController_TextMargins_1.top : 0;
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(UnknownVarFromTextLabelController_TextMargins_1)
            {
               UnknownVarFromTextLabelController_TextMargins_1.dispose();
               UnknownVarFromTextLabelController_TextMargins_1 = null;
            }
            super.dispose();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         if(UnknownVarFromTextLabelController_Boolean_1)
         {
            return;
         }
         UnknownVarFromTextLabelController_Boolean_1 = true;
         var _loc3_:TextField = textField;
         if(!_loc3_)
         {
            UnknownVarFromTextLabelController_Boolean_1 = false;
            return;
         }
         _textWidth = _loc3_.textWidth;
         _textHeight = _loc3_.textHeight;
         var _loc9_:int = _loc3_.border ? 1 : 0;
         _loc11_ = !!UnknownVarFromTextLabelController_TextMargins_1 ? UnknownVarFromTextLabelController_TextMargins_1.left + UnknownVarFromTextLabelController_TextMargins_1.right : 0;
         var _loc10_:int = !!UnknownVarFromTextLabelController_TextMargins_1 ? UnknownVarFromTextLabelController_TextMargins_1.top + UnknownVarFromTextLabelController_TextMargins_1.bottom : 0;
         var _loc4_:int = _width - _loc11_;
         var _loc8_:int = _height - _loc10_;
         ...
         if(_vertical)
         {
            if(_loc2_ != _loc8_)
            {
               setRectangle(_x,_y,_loc6_ + _loc11_,Math.floor(_loc3_.width) + _loc10_);
               _loc5_ = true;
            }
            if(_loc6_ < _loc4_)
            {
         ...
         else
         {
            if(_loc2_ != _loc4_)
            {
               setRectangle(_x,_y,_loc2_ + _loc11_,Math.floor(_loc3_.height) + _loc10_);
               _loc5_ = true;
            }
            if(_loc6_ < _loc8_)
            {
         ...
         if(!_loc5_ && !param1 && UnknownVarFromWindowController_WindowEventDispatcher_1)
         {
            _loc7_ = WindowEvent.allocate("WE_RESIZED",this,null);
            UnknownVarFromWindowController_WindowEventDispatcher_1.dispatchEvent(_loc7_);
            _loc7_.recycle();
         }
      }
      ...
      {
         if(param1 && param1 != UnknownVarFromTextLabelController_TextMargins_1)
         {
            if(UnknownVarFromTextLabelController_TextMargins_1)
            {
               UnknownVarFromTextLabelController_TextMargins_1.assign(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
            }
            else
            {
               UnknownVarFromTextLabelController_TextMargins_1 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
            }
         }
         refresh();
      }
      ...
      private function setTextMarginMap(param1:Map) : void
      {
         if(UnknownVarFromTextLabelController_TextMargins_1)
         {
            UnknownVarFromTextLabelController_TextMargins_1.assign(int(param1["left"]),int(param1["top"]),int(param1["right"]),int(param1["bottom"]),setTextMargins);
         }
         else
         {
            UnknownVarFromTextLabelController_TextMargins_1 = new TextMargins(int(param1["left"]),int(param1["top"]),int(param1["right"]),int(param1["bottom"]),setTextMargins);
         }
         refresh();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc3_.push(createProperty("vertical",_vertical));
         if(UnknownVarFromTextLabelController_TextMargins_1 != null)
         {
            _loc3_.push(createProperty("margin_left",UnknownVarFromTextLabelController_TextMargins_1.left));
            _loc3_.push(createProperty("margin_top",UnknownVarFromTextLabelController_TextMargins_1.top));
            _loc3_.push(createProperty("margin_right",UnknownVarFromTextLabelController_TextMargins_1.right));
            _loc3_.push(createProperty("margin_bottom",UnknownVarFromTextLabelController_TextMargins_1.bottom));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         for each(var _loc2_ in param1)
         {
            ...
            {
               case "text_style":
                  textStyle = TextStyleManager.getStyle(_loc2_.value as String);
                  break;
               case "text_color":
                  _textColor = _loc2_.value as uint;
                  break;
               case "margin_left":
                  if(UnknownVarFromTextLabelController_TextMargins_1 != null || _loc2_.valid)
                  {
