package com.sulake.core.window.components
{
   ...
   {
      public function IconController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindowModel, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
      ...
      public function fitToSize() : void
      {
         ...
         {
            setRectangle(_x,_y,_loc4_,_loc5_);
         }
      }
   }
}
