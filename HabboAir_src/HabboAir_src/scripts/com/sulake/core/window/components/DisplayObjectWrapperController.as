package com.sulake.core.window.components
{
   ...
   public class DisplayObjectWrapperController extends WindowController implements IDisplayObjectWrapperController
   {
      public function DisplayObjectWrapperController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindowModel, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 &= ~0x10;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            UnknownVarFromWindowController_IGraphicContext_1 = new GraphicContext("GC {" + _name + "}",4,rectangle);
         }
