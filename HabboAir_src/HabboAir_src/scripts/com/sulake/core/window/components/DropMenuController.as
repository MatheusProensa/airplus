package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends DropBaseController implements IDropBaseController_1
   {
      private static const DROP_MENU_ITEM_MAX_LENGTH:int = 200;
      
      private var _stringArray:Array = [];
      
      public function DropMenuController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindowModel, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
      ...
      override protected function populateExpandedMenu(param1:Vector.<IWindowModel>, param2:DropBaseController, param3:Function) : void
      {
         ...
         {
            _loc12_ = _stringArray[_loc11_];
            if(_loc12_.length > 200)
            {
               _loc12_ = _loc12_.substring(0,200) + "...";
            }
            _loc5_ = context.create(name + "::menuItem[" + _loc11_ + "]",_loc12_,103,_style,0 | 0 | 0x10 | 1 | 0,null,param3,null,_loc11_,null,"",["_EXCLUDE"]) as DropMenuItemController;
      ...
      override protected function closeExpandedMenuView() : void
      {
         ...
         if(close())
         {
            ...
            if(!disposed)
            {
               ...
               if(_loc1_)
               {
                  _loc1_.text = _selection < _stringArray.length && _selection > -1 ? _stringArray[_selection] : caption;
               }
            }
         }
      }
