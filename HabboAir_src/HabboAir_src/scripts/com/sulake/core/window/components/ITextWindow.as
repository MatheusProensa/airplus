package com.sulake.core.window.components
{
   ...
   public interface ITextWindow extends IWindowModel, IScrollableWindow
   {
      ...
      function get textStyle() : UnknownCoreWindowUtils3;
      ...
      function get isOverflown() : Boolean;
      ...
      function set textStyle(param1:UnknownCoreWindowUtils3) : void;
      ...
      function set maxLines(param1:int) : void;
      
      function set etchingColor(param1:uint) : void;
      
      function set etchingPosition(param1:String) : void;
      
      function set styleSheet(param1:StyleSheet) : void;
      
      function set overflowReplace(param1:String) : void;
