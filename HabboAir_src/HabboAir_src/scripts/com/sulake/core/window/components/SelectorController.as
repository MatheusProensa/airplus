package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      protected var UnknownVarFromSelectorController_Boolean_1:Boolean = true;
      
      public function SelectorController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindowModel, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(param1 != null)
         {
            if(param1 != _selected)
            {
               ...
               if(_selected.select())
               {
                  ...
                  {
                     if(UnknownVarFromSelectorController_Boolean_1)
                     {
