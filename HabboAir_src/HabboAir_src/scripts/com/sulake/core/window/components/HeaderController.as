package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderController
   {
      private static const TAG_TITLE_ELEMENT:String = "_TITLE";
      
      private static const TAG_CONTROLS_ELEMENT:String = "_CONTROLS";
      
      public function HeaderController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindowModel, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 1;
