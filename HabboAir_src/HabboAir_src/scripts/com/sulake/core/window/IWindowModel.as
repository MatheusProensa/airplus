package com.sulake.core.window
{
   ...
   public interface IWindowModel extends IComponentInterfaceQueue
   {
      function get x() : int;
      ...
      function get parent() : IWindowModel;
      ...
      function get context() : IWindowContext_3;
      
      function get desktop() : IDesktopController;
      
      function get host() : IWindowModel;
      ...
      function set parent(param1:IWindowModel) : void;
      ...
      function findParentByName(param1:String) : IWindowModel;
      ...
      function getChildAt(param1:int) : IWindowModel;
      
      function getChildByID(param1:int) : IWindowModel;
      
      function getChildByTag(param1:String) : IWindowModel;
      
      function getChildByName(param1:String) : IWindowModel;
      
      function getChildIndex(param1:IWindowModel) : int;
      
      function enableLookupCache() : void;
      
      function findChildByName(param1:String) : IWindowModel;
      
      function findChildByTag(param1:String) : IWindowModel;
      
      function windowIsChild(param1:IWindowModel) : Boolean;
   }
}
