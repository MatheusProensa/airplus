package com.sulake.core.window.graphics
{
   ...
   public interface IGraphicContext extends IBitmapDrawable, IEventDispatcher, IComponentInterfaceQueue
   {
      ...
      function offSet(param1:Point) : void;
      
      function getDrawRegion() : Rectangle;
      
      function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : BitmapData;
