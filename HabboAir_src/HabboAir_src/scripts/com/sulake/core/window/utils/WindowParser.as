package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const UnknownConstFromWindowParser_String_1:String = "_TEMP";
      
      private static const LAYOUT:String = "layout";
      
      private static const UnknownConstFromWindowParser_String_2:String = "window";
      ...
      private static const UnknownConstFromWindowParser_String_3:String = "dynamic_style";
      ...
      private static const UnknownConstFromWindowParser_String_4:String = "y";
      ...
      private static const UnknownConstFromWindowParser_String_5:String = "width_max";
      
      private static const HEIGHT_MIN:String = "height_min";
      
      private static const UnknownConstFromWindowParser_String_6:String = "height_max";
      ...
      private static const UnknownConstFromWindowParser_String_7:String = "";
      
      private static const UnknownConstFromWindowParser_RegExp_1:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const UnknownConstFromWindowParser_RegExp_2:RegExp = /(\s|\n|\r|\t|\v)*$/;
      
      protected var UnknownVarFromWindowParser_Dictionary_1:Dictionary;
      
      protected var UnknownVarFromWindowParser_Dictionary_2:Dictionary;
      
      protected var UnknownVarFromWindowParser_Dictionary_3:Dictionary;
      
      protected var UnknownVarFromWindowParser_Dictionary_4:Dictionary;
      
      protected var _parsedLayoutCache:Map;
      
      protected var _context:IWindowContext_3;
      
      private var _disposed:Boolean = false;
      
      public function WindowParser(param1:IWindowContext_3)
      {
         super();
         _context = param1;
         UnknownVarFromWindowParser_Dictionary_1 = new Dictionary();
         UnknownVarFromWindowParser_Dictionary_2 = new Dictionary();
         UnknownCoreWindowUtils1.fillTables(UnknownVarFromWindowParser_Dictionary_1,UnknownVarFromWindowParser_Dictionary_2);
         UnknownVarFromWindowParser_Dictionary_3 = new Dictionary();
         UnknownVarFromWindowParser_Dictionary_4 = new Dictionary();
         UnknownCoreWindowUtils4.fillTables(UnknownVarFromWindowParser_Dictionary_3,UnknownVarFromWindowParser_Dictionary_4);
         _parsedLayoutCache = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(UnknownConstFromWindowParser_RegExp_2,"");
         return param1.replace(UnknownConstFromWindowParser_RegExp_1,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in UnknownVarFromWindowParser_Dictionary_1)
            {
               delete UnknownVarFromWindowParser_Dictionary_1[_loc1_];
            }
            for(_loc1_ in UnknownVarFromWindowParser_Dictionary_2)
            {
               delete UnknownVarFromWindowParser_Dictionary_2[_loc1_];
            }
            for(_loc1_ in UnknownVarFromWindowParser_Dictionary_3)
            {
               delete UnknownVarFromWindowParser_Dictionary_3[_loc1_];
            }
            for(_loc1_ in UnknownVarFromWindowParser_Dictionary_4)
            {
               delete UnknownVarFromWindowParser_Dictionary_4[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindowModel, param3:Map) : IWindowModel
      {
         var _loc6_:* = 0;
         var _loc13_:IWindowModel = null;
         var _loc8_:* = 0;
         ...
         {
            _loc9_ = param1.child("variables");
            if(_loc9_.length() > 0)
            {
               _loc5_ = _loc9_[0];
               var _loc7_:XMLList = XML(_loc5_[0]).children();
               if(_loc7_.length() > 0)
               {
                  if(param3 == null)
                  {
                  ...
                  XMLVariableParser.parseVariableList(_loc7_,param3);
               }
            }
            _loc4_ = param1.child("filters").children();
            if(_loc4_.length() > 0)
            {
               _loc11_ = [];
               _loc10_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindowModel
      {
         var _loc9_:* = 0;
         ...
         var _loc13_:String = "";
         var _loc14_:int = 0;
         _loc9_ = uint(UnknownVarFromWindowParser_Dictionary_1[param1.localName()]);
         ...
         _loc10_.x = Number(parseAttribute(param1,"x",param3,"0"));
         ...
         {
            _loc21_ = param1.child("params").children();
            _loc17_ = uint(_loc21_.length());
            _loc18_ = 0;
            while(_loc18_ < _loc17_)
            {
               _loc24_ = _loc21_[_loc18_];
               _loc12_ = parseAttribute(_loc24_,"name",param3,"") as String;
               if(UnknownVarFromWindowParser_Dictionary_3[_loc12_] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(_loc24_.attribute("name")) + "\"!");
               }
               _loc20_ |= UnknownVarFromWindowParser_Dictionary_3[_loc12_];
               _loc18_++;
            }
         }
         ...
         if(_loc13_ != "")
         {
            _loc22_ = _loc13_.split(",");
            _loc17_ = _loc22_.length;
            _loc18_ = 0;
            while(_loc18_ < _loc17_)
            {
         ...
         _loc21_ = param1.child("filters").children();
         _loc17_ = uint(_loc21_.length());
         if(_loc17_ > 0)
         {
            _loc19_ = [];
            ...
            while(_loc18_ < _loc17_)
            {
               _loc23_ = buildBitmapFilter(_loc21_[_loc18_]) as BitmapFilter;
               if(_loc23_ != null)
               {
         ...
         _loc21_ = param1.child("children");
         if(_loc21_.length() > 0)
         {
            _loc24_ = _loc21_[0];
            _loc21_ = _loc24_.children();
            _loc17_ = uint(_loc21_.length());
            if(_loc29_ is IBoxSizerController)
            {
               IBoxSizerController(_loc29_).setAutoRearrange(false);
            }
            _loc18_ = 0;
            while(_loc18_ < _loc17_)
            {
         ...
         if(_loc29_ is IBoxSizerController)
         {
            IBoxSizerController(_loc29_).setAutoRearrange(true);
         }
         return _loc29_;
      }
      ...
      public function windowToXMLString(param1:IWindowModel) : String
      {
         ...
         var _loc11_:String = "";
         var _loc7_:String = UnknownVarFromWindowParser_Dictionary_2[param1.type];
         ...
         {
            _loc10_ = IIterable(_loc16_).iterator;
            ...
            if(_loc5_ > 0)
            {
               ...
               while(_loc6_ < _loc5_)
               {
                  _loc17_ = _loc10_[_loc6_] as IWindowModel;
                  if(_loc17_.tags.indexOf("_EXCLUDE") == -1)
                  {
         ...
         {
            _loc5_ = uint(_loc16_.numChildren);
            if(_loc5_ > 0)
            {
               _loc6_ = 0;
               while(_loc6_ < _loc5_)
               {
                  _loc17_ = _loc16_.getChildAt(_loc6_);
                  if(_loc17_.tags.indexOf("_EXCLUDE") == -1)
                  {
                     _loc2_ += windowToXMLString(_loc17_);
                  }
         ...
         var _loc15_:Array = param1.properties;
         if(_loc15_ != null && _loc15_.length > 0)
         {
            ...
            {
               _loc12_ = _loc15_[_loc6_] as PropertyStruct;
               if(_loc12_.valid)
               {
