...
{
   public class UnknownCoreWindowUtils3
   {
      ...
      public function UnknownCoreWindowUtils3()
      {
         super();
      }
      ...
      public function equals(param1:UnknownCoreWindowUtils3) : Boolean
      {
      ...
      public function clone() : UnknownCoreWindowUtils3
      {
         var _loc1_:UnknownCoreWindowUtils3 = new UnknownCoreWindowUtils3();
         _loc1_.name = name;
         _loc1_.color = color;
