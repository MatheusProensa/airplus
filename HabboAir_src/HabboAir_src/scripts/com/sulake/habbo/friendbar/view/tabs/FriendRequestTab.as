package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const UnknownConstFromFriendRequestTab_String_1:String = "button_close";
      ...
      private static const UnknownConstFromFriendRequestTab_Uint_1:uint = 16767334;
      ...
      private static var UnknownVarFromFriendRequestTab_FriendRequestTab_1:FriendRequestTab;
      
      private var UnknownVarFromFriendRequestTab_String_1:String;
      ...
      public static function allocate(param1:IFriendRequest) : FriendRequestTab
      {
         var _loc3_:IBitmapWrapperController = null;
         var _loc2_:FriendRequestTab = !!UnknownVarFromFriendRequestTab_FriendRequestTab_1 ? UnknownVarFromFriendRequestTab_FriendRequestTab_1 : new FriendRequestTab();
      ...
      override public function recycle() : void
      {
         if(!disposed)
         {
            if(!_recycled)
            {
               _friend = null;
               _recycled = true;
               UnknownVarFromFriendRequestTab_FriendRequestTab_1 = this;
            }
         }
      }
