package com.sulake.habbo.friendbar.view.tabs
{
   ...
   {
      private static const UnknownConstFromNewFriendEntityTab_String_1:String = "new_friend_entity_xml";
      
      private static const UnknownConstFromNewFriendEntityTab_String_2:String = "facebook_piece_xml";
      
      private static const CONTROLS_PIECE_RESOURCE:String = "new_controls_piece_xml";
      
      protected static const PIECES:String = "pieces";
      
      protected static const UnknownConstFromNewFriendEntityTab_String_3:String = "icons";
      
      protected static const HEADER:String = "header";
      
      protected static const PROFILE:String = "region_profile";
      
      protected static const UnknownConstFromNewFriendEntityTab_String_4:String = "facebook";
      ...
      protected static const UnknownConstFromNewFriendEntityTab_String_5:String = "bubble_button_close";
      
      protected static const UnknownConstFromNewFriendEntityTab_String_6:String = "bubble_click_region_reject";
      
      private static const DEFAULT_COLOR:uint = 10338138;
      
      private static const UnknownConstFromNewFriendEntityTab_Uint_1:uint = 13891476;
      ...
      private static const UnknownConstFromNewFriendEntityTab_Vector_1:Vector.<NewFriendEntityTab> = new Vector.<NewFriendEntityTab>();
      
      private static const UnknownConstFromNewFriendEntityTab_Vector_2:Vector.<IWindowController_1> = new Vector.<IWindowController_1>();
      
      protected var _friend:IFriendEntity;
      
      protected var UnknownVarFromNewFriendEntityTab_Vector_1:Vector.<Token>;
      
      protected var _isInGame:Boolean = false;
      
      protected var UnknownVarFromNewFriendEntityTab_String_1:String;
      
      private var UnknownVarFromNewFriendEntityTab_Boolean_1:Boolean;
      
      public function NewFriendEntityTab()
      {
         super();
      }
      
      public static function allocate(param1:IFriendEntity) : NewFriendEntityTab
      {
         var _loc2_:NewFriendEntityTab = UnknownConstFromNewFriendEntityTab_Vector_1.length > 0 ? UnknownConstFromNewFriendEntityTab_Vector_1.pop() : new NewFriendEntityTab();
      ...
      override public function recycle() : void
      {
         if(!disposed)
         {
            if(!_recycled)
            {
               ...
               if(UnknownVarFromNewFriendEntityTab_Vector_1)
               {
                  while(UnknownVarFromNewFriendEntityTab_Vector_1.length > 0)
                  {
                     UnknownVarFromNewFriendEntityTab_Vector_1.pop().dispose();
                  }
                  UnknownVarFromNewFriendEntityTab_Vector_1 = null;
               }
               _friend = null;
               _isInGame = false;
               UnknownVarFromNewFriendEntityTab_String_1 = "";
               _recycled = true;
               UnknownConstFromNewFriendEntityTab_Vector_1.push(this);
            }
         }
      }
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            if(UnknownVarFromNewFriendEntityTab_Vector_1)
            {
               for each(var _loc11_ in UnknownVarFromNewFriendEntityTab_Vector_1)
               {
            ...
            if(friend.online)
            {
               _loc6_ = WINDOWING.buildFromXML(ASSETS.getAssetByName("new_controls_piece_xml").content as XML) as IWindowController_1;
               ...
               else
               {
                  ...
                  if(_loc2_)
                  {
                     _loc5_ = UnknownVarFromTab_IHabboLocalizationManager_1.getLocalization("gamecenter." + UnknownVarFromNewFriendEntityTab_String_1 + ".name");
               ...
               _loc2_ = _loc6_.getChildByName("btn_chat");
               if(_loc2_)
               {
                  _loc2_.addEventListener("WME_CLICK",onButtonClick);
               }
      ...
      override public function deselect(param1:Boolean) : void
      {
         ...
         if(selected)
         {
            if(_window)
            {
               ...
               if(UnknownVarFromNewFriendEntityTab_Vector_1)
               {
                  _loc3_ = UnknownVarFromNewFriendEntityTab_Vector_1.length - 1;
                  while(_loc3_ > -1)
                  {
                     _loc4_ = UnknownVarFromNewFriendEntityTab_Vector_1[_loc3_];
                     if(_loc4_.viewOnce)
                     {
      ...
      {
         UnknownVarFromNewFriendEntityTab_Boolean_1 = false;
         AVATAR_RENDER_MANAGER.events.removeEventListener("AVATAR_RENDER_READY",onAvatarRendererReady);
         refresh();
      }
      ...
      protected function refresh() : void
      {
         ...
         if(!AVATAR_RENDER_MANAGER.isReady)
         {
            if(!UnknownVarFromNewFriendEntityTab_Boolean_1)
            {
               AVATAR_RENDER_MANAGER.events.addEventListener("AVATAR_RENDER_READY",onAvatarRendererReady);
               UnknownVarFromNewFriendEntityTab_Boolean_1 = true;
            }
            return;
         }
         if(_friend)
      ...
      {
         var _loc1_:IWindowController_1 = UnknownConstFromNewFriendEntityTab_Vector_2.length > 0 ? UnknownConstFromNewFriendEntityTab_Vector_2.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName("new_friend_entity_xml").content as XML) as IWindowController_1;
      ...
      private function releaseFriendTabWindow(param1:IWindowController_1) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            if(UnknownConstFromNewFriendEntityTab_Vector_2.indexOf(param1) == -1)
            {
               UnknownConstFromNewFriendEntityTab_Vector_2.push(param1);
            }
         }
      }
            ...
            switch(param1.window.name)
            {
               ...
               case "icon_game":
                  if(GAMES)
                  {
                     ...
                     DATA.sendGameButtonTracking(UnknownVarFromNewFriendEntityTab_String_1);
                  }
            }
         }
      }
      ...
      public function addNotificationToken(param1:IFriendNotification) : void
      {
         ...
         if(!UnknownVarFromNewFriendEntityTab_Vector_1)
         {
            UnknownVarFromNewFriendEntityTab_Vector_1 = new Vector.<Token>();
         }
         var _loc2_:Boolean = selected;
         if(_loc2_)
         {
            _loc6_ = UnknownVarFromNewFriendEntityTab_Vector_1;
            UnknownVarFromNewFriendEntityTab_Vector_1 = null;
            deselect(false);
            UnknownVarFromNewFriendEntityTab_Vector_1 = _loc6_;
         }
         ...
         switch(param1.typeCode - -1)
         {
            ...
            case 4:
               ...
               _isInGame = true;
               UnknownVarFromNewFriendEntityTab_String_1 = _loc7_.notification.message;
               break;
            case 5:
         ...
         if(_loc7_)
         {
            UnknownVarFromNewFriendEntityTab_Vector_1.push(_loc7_);
            if(_loc3_ != null)
            {
      ...
      public function removeNotificationToken(param1:int, param2:Boolean) : void
      {
         ...
         while(_loc3_ > -1)
         {
            ...
            {
               UnknownVarFromNewFriendEntityTab_Vector_1.splice(_loc3_,1);
               if(param2)
               {
