package com.sulake.habbo.friendbar.talent
{
   ...
   public class HabboTalent extends AbstractView implements IHabboTalent, ILinkEventTracker
   {
      ...
      public function HabboTalent(param1:IComponent_2, param2:uint, param3:IAssetLibraryCollection)
      {
      ...
      public function testLevelUp(param1:String, param2:TalentTrackLevel) : void
      {
