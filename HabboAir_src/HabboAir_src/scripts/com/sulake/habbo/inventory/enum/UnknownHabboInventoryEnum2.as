...
{
   public class UnknownHabboInventoryEnum2
   {
      public static const DEFAULT:int = 1;
      
      public static const WALL_PAPER:int = 2;
      
      public static const UnknownConstFromUnknownHabboInventoryEnum2_Int_1:int = 3;
      ...
      public static const PET_CUSTOM_PART_SHAMPOO:int = 15;
      
      public static const PET_SADDLE:int = 16;
      
      public static const GUILD_FURNI:int = 17;
      ...
      public static const FURNI_CHEST:int = 24;
      
      public static const COINS_CHEST:int = 25;
      
      public function UnknownHabboInventoryEnum2()
      {
         super();
      }
   }
