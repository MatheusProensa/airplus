package com.sulake.habbo.inventory.events
{
   public class HabboInventoryTrackingEvent
   {
      ...
      public static const HABBO_INVENTORY_TRACKING_EVENT_COLLECTIBLES:String = "HABBO_INVENTORY_TRACKING_EVENT_COLLECTIBLES";
      
      public function HabboInventoryTrackingEvent()
      {
         super();
      }
   }
