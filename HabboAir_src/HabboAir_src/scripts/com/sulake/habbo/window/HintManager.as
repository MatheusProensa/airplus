package com.sulake.habbo.window
{
   ...
   public class HintManager implements IComponentInterfaceQueue, IProfiler_1
   {
      private static const UnknownConstFromHintManager_Int_1:int = 10;
      
      private static const UnknownConstFromHintManager_Int_2:int = 400;
      
      private static const UnknownConstFromHintManager_Int_3:int = 15;
      ...
      private var UnknownVarFromHintManager_Rectangle_1:Rectangle;
      
      private var UnknownVarFromHintManager_Rectangle_2:Rectangle;
      ...
      public function registerWindow(param1:String, param2:IWindowModel, param3:int) : void
      {
      ...
      public function showHint(param1:String, param2:Rectangle = null) : void
      {
         ...
         if(_loc3_ != null && _loc3_.window != null && param1 != activeKey)
         {
            ...
            _activeHint = _loc3_;
            UnknownVarFromHintManager_Rectangle_1 = param2;
            UnknownVarFromHintManager_Rectangle_2 = getTargetRect(_activeHint.window);
            if(param2 != null)
            {
               animateHint(param2);
            }
      ...
      protected function animateHint(param1:Rectangle) : void
      {
         ...
         _hint.y = param1.y;
         _hint.visible = true;
         var _loc3_:int = param1.x - UnknownVarFromHintManager_Rectangle_2.x;
         var _loc6_:int = param1.y - UnknownVarFromHintManager_Rectangle_2.y;
         ...
         _hint.width *= 0.4;
         _hint.height *= 0.4;
         var _loc5_:Motion = new Queue(new Combo(new EaseOut(new MoveTo(_hint,_loc2_,UnknownVarFromHintManager_Rectangle_2.x,UnknownVarFromHintManager_Rectangle_2.y),1),new ResizeTo(_hint,_loc2_,_loc8_,_loc7_)),new Callback(motionComplete));
         Motions.runMotion(_loc5_);
      }
      ...
      private function getTargetRect(param1:IWindowModel) : Rectangle
      {
