package com.sulake.habbo.window.utils.floorplaneditor
{
   ...
   public class FloorPlanCache
   {
      ...
      {
         var _loc2_:RoomOccupiedTilesMessageParser = null;
         if(_floorPlanCache)
         {
      ...
      {
         if(_floorPlanCache == null || !checkSizeLimits(param2 + 1,param1 + 1))
         {
            return false;
         }
