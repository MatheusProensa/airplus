package com.sulake.habbo.window.utils.floorplaneditor
{
   ...
   public class BCFloorPlanEditor implements IProfiler_1
   {
      private static const PREVIEW_UPDATE_MS:uint = 2000;
      
      private static const WALL_HEIGHT_LIMIT:int = 16;
      
      public static var floor_plan_editor_layout:Class = floor_plan_editor_bc_1_xml;
      
      public static var floor_plan_editor_export_import:Class = floor_plan_export_import_1_xml;
      ...
      private var _editorWindow:IFrameController;
      ...
      private function createEditorWindow() : void
      {
         ...
         _editorWindow = _windowManager.buildFromXML(_loc2_,1) as IFrameController;
         _editorWindow.enableLookupCache();
      ...
      public function update(param1:uint) : void
      {
         if(_drawMode != "" && _editorWindow)
         {
            for each(var _loc2_ in _drawModes)
            {
               if(_drawMode == _loc2_)
               {
                  InteractiveController(_editorWindow.findChildByName(_loc2_)).state = InteractiveController(_editorWindow.findChildByName(_loc2_)).state | 0x10;
               }
               else
               {
                  InteractiveController(_editorWindow.findChildByName(_loc2_)).state = InteractiveController(_editorWindow.findChildByName(_loc2_)).state & ~0x10;
      ...
      {
         return UnknownICoreWindowComponents2(_editorWindow.findChildByName("walls_fixed_height_enabled_checkbox")).isSelected;
      }
         ...
         if(param1.type == "WME_CLICK")
         {
            switch(param2.name)
            {
               ...
               case "refresh":
                  ...
                  break;
               case "save":
                  _floorThickness = IDropBaseController_1(_editorWindow.findChildByName("floor_thickness_drop")).selection;
                  _wallThickness = IDropBaseController_1(_editorWindow.findChildByName("wall_thickness_drop")).selection;
      ...
      private function colorMapWindowProcedure(param1:WindowEvent, param2:IWindowModel) : void
      {
      ...
      private function wallHeightSliderProcedure(param1:WindowEvent, param2:IWindowModel) : void
      {
         var _loc3_:WindowMouseEvent = null;
         var _loc4_:* = 0;
         if(param1.type == "WME_DOWN")
      ...
      public function updateWallHeight(param1:int) : void
      {
         if(param1 == -1)
         {
            UnknownICoreWindowComponents2(_editorWindow.findChildByName("walls_fixed_height_enabled_checkbox")).unselect();
            enableWallHeightControls(false);
         }
         else
         {
            UnknownICoreWindowComponents2(_editorWindow.findChildByName("walls_fixed_height_enabled_checkbox")).select();
      ...
      private function onEntryTileData(param1:RoomEntryTileMessageEvent) : void
      {
         ...
         var _loc2_:RoomEntryTileMessageParser = param1.getParser();
      ...
      {
         var _loc2_:RoomVisualizationSettingsParser = param1.getParser();
      ...
      {
         var _loc2_:IBitmapWrapperController = IBitmapWrapperController(_editorWindow.findChildByName("preview_bitmap"));
      ...
      private function createTileHeightColorMap(param1:Vector.<Array>) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc2_:* = 0;
         var _loc6_:IBitmapWrapperController = _editorWindow.findChildByName("tile_height_colormap") as IBitmapWrapperController;
         _loc6_.bitmap = new BitmapData(_loc6_.width,_loc6_.height,false,0);
      ...
      {
         var _loc1_:IAvatarImageWidget = IWidgetWindowController(_editorWindow.findChildByName("enterdirection_ghost_avatar")).widget as IAvatarImageWidget;
      ...
      private function updateThicknessSelection() : void
      {
         if(_editorWindow)
         {
            IDropBaseController_1(_editorWindow.findChildByName("wall_thickness_drop")).selection = _wallThickness;
            IDropBaseController_1(_editorWindow.findChildByName("floor_thickness_drop")).selection = _floorThickness;
         }
      }
      ...
      public function get heightMapBitmapElement() : IBitmapWrapperController
      {
         return _editorWindow.findChildByName("heightmap_bitmap") as IBitmapWrapperController;
      }
      
      public function get heightMapMouseCapturer() : IRegionWindow
      {
         return _editorWindow.findChildByName("mouse_capturer") as IRegionWindow;
      }
