package com.sulake.habbo.window.utils
{
   ...
   import com.sulake.core.window.graphics.renderer.BitmapFillSkinRenderer;
   ...
   import com.sulake.core.window.graphics.renderer.StrokeSkinRenderer;
   import com.sulake.core.window.graphics.renderer.TextSkinRenderer;
   import com.sulake.core.window.utils.DefaultAttStruct;
   import com.sulake.core.window.utils.UnknownCoreWindowUtils1;
   import com.sulake.core.window.utils.UnknownCoreWindowUtils2;
   ...
   public class SkinParserUtil
   {
      ...
      private static const RENDERER_TYPE_GRADIENT:String = "gradient";
      ...
      private static const RENDERER_TYPE_BITMAP_FILL:String = "bitmap_fill";
      
      private static const RENDERER_TYPE_STROKE:String = "stroke";
      
      private static const RENDERER_TYPE_UNKNOWN:String = "unknown";
      
      private static const RENDERER_TYPE_NULL:String = "null";
      
      public function SkinParserUtil()
      {
         super();
      }
      
      public static function parse(param1:XML, param2:IAssetLibraryCollection, param3:SkinContainer) : void
      {
         var _loc9_:XML = null;
         ...
         if(param1 != null)
         {
            ...
            if(_loc7_ > 0)
            {
               ...
               {
                  _loc9_ = _loc30_[_loc24_];
                  _loc8_ = _loc9_.attribute("type");
                  ...
                  _loc16_ = _loc12_[_loc14_];
                  if(_loc16_)
                  {
                     _loc4_ = new _loc16_(_loc10_);
                     if(_loc4_)
                     {
                  ...
                  _loc26_ = new DefaultAttStruct();
                  _loc26_.threshold = !!_loc9_.@treshold[0] ? uint(_loc9_.@treshold[0]) : 10;
                  ...
                  if(_loc25_ != null)
                  {
                     _loc13_ = param2.getAssetByName(_loc25_);
                     if(_loc13_ != null)
                     {
