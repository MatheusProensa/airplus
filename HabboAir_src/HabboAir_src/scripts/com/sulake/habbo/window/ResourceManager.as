package com.sulake.habbo.window
{
   ...
   public class ResourceManager implements IResourceManager
   {
      ...
      public function retrieveAsset(param1:String, param2:UnknownICoreAssets1) : void
      {
         ...
         var _loc7_:String = resolveAssetName(param1);
         if(_loc7_ == null)
         {
            return;
         }
         var _loc8_:ISoundAsset = _windowManager.assets.getAssetByName(_loc7_);
         if(_loc8_ == null)
         {
            if(_loc7_.substr(0,7) == "http://" || _loc7_.substr(0,8) == "https://")
            {
               ...
               {
                  _loc5_ = _windowManager.assets.getAssetByName("missing_image_icon") as BitmapDataAsset;
                  _loc4_ = _loc5_.content as BitmapData;
                  _loc6_ = new BitmapDataAsset(null);
                  _loc6_.setUnknownContent(_loc4_.clone());
      ...
      private function passAssetToCallback(param1:AssetLoaderEvent = null) : void
      {
         ...
         var _loc4_:ISoundAsset = _windowManager.assets.getAssetByName(_loc3_.assetName);
      ...
      public function createAsset(param1:String, param2:Class, param3:Object) : ISoundAsset
      {
         var _loc4_:ISoundAsset = new param2(_windowManager.assets.getAssetTypeDeclarationByClass(param2));
