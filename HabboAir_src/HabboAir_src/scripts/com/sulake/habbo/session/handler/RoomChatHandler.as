package com.sulake.habbo.session.handler
{
   ...
   import com.sulake.habbo.communication.messages.incoming.room.chat.SpecialSystemChatMessageEvent;
   ...
   public class RoomChatHandler extends BaseHandler
   {
      public function RoomChatHandler(param1:IConnection, param2:IRoomHandlerListener)
      {
         ...
         param1.addMessageEvent(new SpecialSystemChatMessageEvent(onSpecialSystemChat));
      ...
      private function onRoomChat(param1:IMessageEvent) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc3_:ChatMessageParser = null;
         if(listener && listener.events)
         {
            _loc2_ = param1 as ChatMessageEvent;
            if(_loc2_ && _loc2_.getParser())
            {
               _loc4_ = listener.getSession(UnknownVarFromBaseHandler_Int_1);
               if(_loc4_ == null)
               {
                  return;
               }
      ...
      private function onSpecialSystemChat(param1:IMessageEvent) : void
      {
         if(param1 == null || listener == null || listener.events == null)
         {
            return;
         }
         var _loc2_:SpecialSystemChatMessageEvent = param1 as SpecialSystemChatMessageEvent;
         if(_loc2_ == null)
         {
            return;
         }
         var _loc4_:SpecialSystemChatMessageParser = _loc2_.getParser();
         if(_loc4_ == null)
         {
            return;
         }
         ...
         var _loc3_:IUserData = _loc5_.userDataManager.getUserDataByIndex(_loc4_.userIndex);
         if(_loc3_ == null)
         {
            return;
         }
         listener.events.dispatchEvent(new RoomSessionChatEvent("RSCE_CHAT_EVENT",_loc5_,_loc3_.roomObjectId,"",12,1,null,_loc4_.specialSystemType));
      }
      ...
      private function onPetRespectNotification(param1:PetRespectNotificationEvent) : void
      {
         ...
         var _loc3_:PetRespectNotificationParser = param1.getParser();
         if(_loc3_ == null)
         {
            return;
         }
         ...
         var _loc2_:IUserData = _loc4_.userDataManager.getPetUserData(_loc3_.petData.id);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function onPetSupplementedNotification(param1:PetSupplementedNotificationEvent) : void
      {
         ...
         var _loc3_:PetSupplementedNotificationParser = param1.getParser();
         if(_loc3_ == null)
         {
            return;
         }
         ...
         var _loc2_:IUserData = _loc4_.userDataManager.getPetUserData(_loc3_.petId);
         if(_loc2_ == null)
         {
            return;
         }
         var _loc6_:int = -1;
         var _loc5_:IUserData = _loc4_.userDataManager.getUserData(_loc3_.userId);
         if(_loc5_ != null)
         {
      ...
      private function onHandItemNotification(param1:HandItemReceivedMessageEvent) : void
      {
         ...
         if(listener && listener.events)
         {
            _loc2_ = listener.getSession(UnknownVarFromBaseHandler_Int_1);
            if(_loc2_)
            {
      ...
      {
         var _loc3_:FloodControlMessageParser = null;
         var _loc4_:IRoomSession = null;
         var _loc2_:int = 0;
         if(listener && listener.events)
         {
            ...
            Logger.log("received flood control event for " + _loc2_ + " seconds");
