package com.sulake.habbo.game.snowwar
{
   ...
   public class KeyboardControl implements IComponentInterfaceQueue
   {
      ...
      private static const UnknownConstFromKeyboardControl_Uint_1:uint = 67;
      ...
      private static const UnknownConstFromKeyboardControl_Uint_2:uint = 71;
      
      private static const UnknownConstFromKeyboardControl_Uint_3:uint = 72;
      
      private static const I:uint = 73;
      
      private static const UnknownConstFromKeyboardControl_Uint_4:uint = 74;
      
      private static const UnknownConstFromKeyboardControl_Uint_5:uint = 75;
      ...
      private static const UnknownConstFromKeyboardControl_Uint_6:uint = 79;
      
      private static const UnknownConstFromKeyboardControl_Uint_7:uint = 80;
      
      private static const UnknownConstFromKeyboardControl_Uint_8:uint = 81;
      
      private static const UnknownConstFromKeyboardControl_Uint_9:uint = 82;
      
      private static const S:uint = 83;
      
      private static const UnknownConstFromKeyboardControl_Uint_10:uint = 84;
      ...
      private static const UnknownConstFromKeyboardControl_Uint_11:uint = 89;
      
      private static const UnknownConstFromKeyboardControl_Uint_12:uint = 90;
      
      private static const UnknownConstFromKeyboardControl_Uint_13:uint = 186;
      ...
      private static const UnknownConstFromKeyboardControl_Uint_14:uint = 222;
      ...
      private static const UnknownConstFromKeyboardControl_Uint_15:uint = 35;
      ...
      private static const UnknownConstFromKeyboardControl_Uint_16:uint = 37;
      ...
      private static const UnknownConstFromKeyboardControl_Uint_17:uint = 32;
      
      private static const TAB:uint = 9;
      
      private static const UnknownConstFromKeyboardControl_Uint_18:uint = 38;
      
      private var UnknownVarFromKeyboardControl_Stage_1:Stage;
      
      private var UnknownVarFromKeyboardControl_Array_1:Array = [];
      ...
      {
         super();
         UnknownVarFromKeyboardControl_Stage_1 = param1;
      ...
      {
         UnknownVarFromKeyboardControl_Stage_1.removeEventListener("keyDown",keyboardEventHandler);
         UnknownVarFromKeyboardControl_Stage_1.removeEventListener("keyUp",keyboardEventHandler);
         UnknownVarFromKeyboardControl_Stage_1 = null;
         _direction = null;
         UnknownVarFromKeyboardControl_Array_1 = [];
      }
      ...
      {
         var _loc2_:int = int(UnknownVarFromKeyboardControl_Array_1.indexOf(param1.keyCode));
         switch(param1.type)
         {
            case "keyDown":
               if(_loc2_ == -1)
               {
                  UnknownVarFromKeyboardControl_Array_1.push(param1.keyCode);
               }
               break;
            case "keyUp":
               if(_loc2_ > -1)
               {
                  UnknownVarFromKeyboardControl_Array_1.splice(_loc2_,1);
               }
         }
         _direction = null;
         if(UnknownVarFromKeyboardControl_Array_1.length == 0)
         {
            return;
         }
         if(UnknownVarFromKeyboardControl_Array_1.length >= 2)
         {
      ...
      {
         return UnknownVarFromKeyboardControl_Array_1.indexOf(param1) > -1;
      }
