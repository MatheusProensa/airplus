package com.sulake.habbo.game.snowwar
{
   ...
   public class SnowWarGameStage extends SynchronizedGameStage
   {
      ...
      private function checkAndAdjustNeighbouringTiles(param1:FuseObjectData) : void
      {
         ...
         while(_loc6_ < _loc3_)
         {
            _loc5_ = getTileAt(param1.x + _loc6_,param1.y);
            if(_loc5_)
            {
         ...
         while(_loc6_ < _loc4_)
         {
            _loc5_ = getTileAt(param1.x,param1.y + _loc6_);
            if(_loc5_)
            {
               _loc5_.addToHeight(param1.height);
               if(!param1.canStandOn)
         ...
         while(_loc10_ < _loc9_)
         {
            ...
            while(_loc8_ < _loc4_)
            {
               ...
               if(_loc5_[_loc10_][_loc8_] != 100000)
               {
                  ...
                  _loc11_ = getTileAt(_loc8_ + 1,_loc10_ - 1);
                  if(_loc11_ != null)
                  {
                     _loc7_.linkTile(_loc11_,Direction8.NE);
                  }
                  _loc6_ = getTileAt(_loc8_,_loc10_ - 1);
                  if(_loc6_ != null)
                  {
      ...
      public function testCollisionWithGround(param1:UnknownIHabboGameSnowwarUtils1) : Boolean
      {
