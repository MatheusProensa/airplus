package com.sulake.habbo.game.snowwar.utils
{
   public class CollisionDetection
   {
      ...
      public static function testForObjectToObjectCollision(param1:UnknownIHabboGameSnowwarUtils1, param2:UnknownIHabboGameSnowwarUtils1) : Boolean
      {
         if(param2 == param1)
         {
            return false;
      ...
      private static function testPointToCircleCollision(param1:UnknownIHabboGameSnowwarUtils1, param2:UnknownIHabboGameSnowwarUtils1) : Boolean
      {
         return param1.location3D.isInDistance(param2.location3D,param2.boundingData[0]);
      }
      
      private static function testPointToBoxCollision(param1:UnknownIHabboGameSnowwarUtils1, param2:UnknownIHabboGameSnowwarUtils1) : Boolean
      {
      ...
      private static function testCircleToCircleCollision(param1:UnknownIHabboGameSnowwarUtils1, param2:UnknownIHabboGameSnowwarUtils1) : Boolean
      {
         return param1.location3D.isInDistance(param2.location3D,param1.boundingData[0] + param2.boundingData[0]);
      }
      
      private static function testPointToTripleCircleCollision(param1:UnknownIHabboGameSnowwarUtils1, param2:UnknownIHabboGameSnowwarUtils1) : Boolean
      {
         var _loc8_:int = absoluteValue(param2.location3D.x - param1.location3D.x);
         if(_loc8_ > param2.boundingData[5])
         {
            return false;
         }
         var _loc7_:int = absoluteValue(param2.location3D.y - param1.location3D.y);
         if(_loc7_ > param2.boundingData[5])
         {
            return false;
         }
         var _loc5_:int = param2.location3D.x + UnknownHabboGameSnowwarUtils1.javaDiv(Direction360.getBaseVectorXComponent(param2.direction360.intValue()) * param2.boundingData[3] / 256);
         var _loc6_:int = param2.location3D.y + UnknownHabboGameSnowwarUtils1.javaDiv(Direction360.getBaseVectorYComponent(param2.direction360.intValue()) * param2.boundingData[3] / 256);
         ...
         var _loc3_:int = param2.location3D.x + UnknownHabboGameSnowwarUtils1.javaDiv(Direction360.getBaseVectorXComponent(param2.direction360.intValue()) * param2.boundingData[4] / 256);
         var _loc4_:int = param2.location3D.y + UnknownHabboGameSnowwarUtils1.javaDiv(Direction360.getBaseVectorYComponent(param2.direction360.intValue()) * param2.boundingData[4] / 256);
      ...
      private static function testCircleToTripleCircleCollision(param1:UnknownIHabboGameSnowwarUtils1, param2:UnknownIHabboGameSnowwarUtils1) : Boolean
      {
         var _loc8_:int = absoluteValue(param2.location3D.x - param1.location3D.x);
         if(_loc8_ > param1.boundingData[0] + param2.boundingData[5])
         {
            return false;
         }
         var _loc7_:int = absoluteValue(param2.location3D.y - param1.location3D.y);
         if(_loc7_ > param1.boundingData[0] + param2.boundingData[5])
         {
            return false;
         }
         var _loc5_:int = param2.location3D.x + UnknownHabboGameSnowwarUtils1.javaDiv(Direction360.getBaseVectorXComponent(param2.direction360.intValue()) * param2.boundingData[3] / 256);
      ...
      private static function testTripleCircleToTripleCircleCollision(param1:UnknownIHabboGameSnowwarUtils1, param2:UnknownIHabboGameSnowwarUtils1) : Boolean
      {
         var _loc11_:int = absoluteValue(param2.location3D.x - param1.location3D.x);
         if(_loc11_ > param1.boundingData[5] + param2.boundingData[5])
         {
            return false;
         }
         var _loc10_:int = absoluteValue(param2.location3D.y - param1.location3D.y);
         if(_loc10_ > param1.boundingData[5] + param2.boundingData[5])
         {
            return false;
         }
         var _loc5_:int = param1.location3D.x + UnknownHabboGameSnowwarUtils1.javaDiv(Direction360.getBaseVectorXComponent(param1.direction360.intValue()) * param1.boundingData[3] / 256);
         var _loc3_:int = param1.location3D.y + UnknownHabboGameSnowwarUtils1.javaDiv(Direction360.getBaseVectorYComponent(param1.direction360.intValue()) * param1.boundingData[3] / 256);
         var _loc12_:int = param2.location3D.x + UnknownHabboGameSnowwarUtils1.javaDiv(Direction360.getBaseVectorXComponent(param2.direction360.intValue()) * param2.boundingData[3] / 256);
         var _loc6_:int = param2.location3D.y + UnknownHabboGameSnowwarUtils1.javaDiv(Direction360.getBaseVectorYComponent(param2.direction360.intValue()) * param2.boundingData[3] / 256);
         ...
         var _loc4_:int = param2.location3D.x + UnknownHabboGameSnowwarUtils1.javaDiv(Direction360.getBaseVectorXComponent(param2.direction360.intValue()) * param2.boundingData[4] / 256);
         var _loc8_:int = param2.location3D.y + UnknownHabboGameSnowwarUtils1.javaDiv(Direction360.getBaseVectorYComponent(param2.direction360.intValue()) * param2.boundingData[4] / 256);
         ...
         var _loc9_:int = param1.location3D.x + UnknownHabboGameSnowwarUtils1.javaDiv(Direction360.getBaseVectorXComponent(param1.direction360.intValue()) * param1.boundingData[4] / 256);
         var _loc7_:int = param1.location3D.y + UnknownHabboGameSnowwarUtils1.javaDiv(Direction360.getBaseVectorYComponent(param1.direction360.intValue()) * param1.boundingData[4] / 256);
