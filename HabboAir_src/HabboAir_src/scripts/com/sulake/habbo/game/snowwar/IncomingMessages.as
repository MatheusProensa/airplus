package com.sulake.habbo.game.snowwar
{
   ...
   {
      private var UnknownVarFromIncomingMessages_SnowWarEngine_1:SnowWarEngine;
      
      private var _disposed:Boolean = false;
      
      public function IncomingMessages(param1:SnowWarEngine)
      {
         super();
         UnknownVarFromIncomingMessages_SnowWarEngine_1 = param1;
         var _loc2_:IHabboCommunicationManager = UnknownVarFromIncomingMessages_SnowWarEngine_1.communication;
      ...
      {
         UnknownVarFromIncomingMessages_SnowWarEngine_1 = null;
         _disposed = true;
      }
      ...
      {
         var _loc3_:Game2EnterArenaMessageParser = param1.getParser();
         UnknownVarFromIncomingMessages_SnowWarEngine_1.initArena(_loc3_.gameType,_loc3_.fieldType,_loc3_.numberOfTeams,_loc3_.players);
         var _loc2_:SynchronizedGameArena = UnknownVarFromIncomingMessages_SnowWarEngine_1.gameArena;
         var _loc4_:SynchronizedGameStage = _loc2_.getCurrentStage();
         _loc4_.initialize(UnknownVarFromIncomingMessages_SnowWarEngine_1.gameArena,_loc3_.gameLevel);
         UnknownVarFromIncomingMessages_SnowWarEngine_1.mainView.close(false);
      }
      
      private function onEnterArenaFailed(param1:Game2EnterArenaFailedMessageEvent) : void
      {
         var _loc2_:Game2EnterArenaFailedMessageParser = param1.getParser();
         ...
         UnknownVarFromIncomingMessages_SnowWarEngine_1.alert("${" + _loc3_ + "}");
      }
      
      private function onArenaEntered(param1:Game2ArenaEnteredMessageEvent) : void
      {
         var _loc2_:Game2ArenaEnteredMessageParser = param1.getParser();
         var _loc3_:Game2PlayerData = _loc2_.player;
      }
      
      private function onStageLoad(param1:Game2StageLoadMessageEvent) : void
      {
         var _loc2_:Game2StageLoadMessageParser = param1.getParser();
         UnknownVarFromIncomingMessages_SnowWarEngine_1.initView();
      }
      
      private function onStageStillLoading(param1:Game2StageStillLoadingMessageEvent) : void
      {
         var _loc2_:Game2StageStillLoadingMessageParser = param1.getParser();
         UnknownVarFromIncomingMessages_SnowWarEngine_1.stageLoading(_loc2_.percentage,_loc2_.finishedPlayers);
      }
      
      private function onStageStarting(param1:Game2StageStartingMessageEvent) : void
      {
         var _loc3_:Game2StageStartingMessageParser = param1.getParser();
         ...
         UnknownVarFromIncomingMessages_SnowWarEngine_1.startStage(_loc3_.countDown);
      }
      
      private function onStageRunning(param1:Game2StageRunningMessageEvent) : void
      {
         var _loc2_:Game2StageRunningMessageParser = param1.getParser();
         HabboGamesCom.log("[HabbosnowWarEngine] On stage running: " + _loc2_.timeToStageEnd);
         UnknownVarFromIncomingMessages_SnowWarEngine_1.stageRunning(_loc2_.timeToStageEnd);
      }
      
      private function onStageEnding(param1:Game2StageEndingMessageEvent) : void
      {
         var _loc2_:Game2StageEndingMessageParser = param1.getParser();
         HabboGamesCom.log("[HabbosnowWarEngine] On stage ending: " + _loc2_.timeToNextState);
         if(_loc2_.timeToNextState == 0)
         {
            UnknownVarFromIncomingMessages_SnowWarEngine_1.resetGameSession();
         }
      }
      
      private function onGameEnding(param1:Game2GameEndingMessageEvent) : void
      {
         var _loc2_:Game2GameEndingMessageParser = param1.getParser();
         HabboGamesCom.log("[HabbosnowWarEngine] On game ending: " + _loc2_.timeToNextState);
         UnknownVarFromIncomingMessages_SnowWarEngine_1.gameOver(_loc2_.timeToNextState,_loc2_.teams,_loc2_.generalStats,_loc2_.gameResult);
      }
      
      private function onPlayerExitedArena(param1:Game2PlayerExitedGameArenaMessageEvent) : void
      {
         var _loc2_:Game2PlayerExitedGameArenaMessageParser = param1.getParser();
      ...
      {
         var _loc2_:Game2GameRejoinMessageParser = param1.getParser();
         HabboGamesCom.log("Rejoin game! Room Before game: " + _loc2_.roomBeforeGame);
         UnknownVarFromIncomingMessages_SnowWarEngine_1.rejoinGame(_loc2_.roomBeforeGame);
      }
      
      private function onPlayerRematches(param1:Game2PlayerRematchesMessageEvent) : void
      {
         var _loc2_:Game2PlayerRematchesMessageParser = param1.getParser();
         HabboGamesCom.log("User " + _loc2_.userId + " rematches");
         UnknownVarFromIncomingMessages_SnowWarEngine_1.playerRematches(_loc2_.userId);
      }
      ...
      private function onGameDirectoryStatus(param1:Game2GameDirectoryStatusMessageEvent) : void
      {
         ...
         if(_loc2_.status == 0)
         {
            UnknownVarFromIncomingMessages_SnowWarEngine_1.mainView.changeBlockStatus(_loc2_.blockLength);
            UnknownVarFromIncomingMessages_SnowWarEngine_1.gamesPlayed = _loc2_.gamesPlayed;
            UnknownVarFromIncomingMessages_SnowWarEngine_1.onGameDirectoryAvailable(true);
            UnknownVarFromIncomingMessages_SnowWarEngine_1.gamesLeft(0,_loc2_.freeGamesLeft == -1,_loc2_.freeGamesLeft);
         }
         else
         {
            UnknownVarFromIncomingMessages_SnowWarEngine_1.onGameDirectoryAvailable(false);
      ...
      private function onAccountGameStatus(param1:Game2AccountGameStatusMessageEvent) : void
      {
         ...
         UnknownVarFromIncomingMessages_SnowWarEngine_1.gamesLeft(_loc2_.gameTypeId,_loc2_.hasUnlimitedGames,_loc2_.freeGamesLeft);
      }
      
      private function onGameCreated(param1:Game2GameCreatedMessageEvent) : void
      {
         var _loc2_:Game2GameCreatedMessageParser = param1.getParser();
         var _loc3_:GameLobbyData = _loc2_.gameLobbyData;
         UnknownVarFromIncomingMessages_SnowWarEngine_1.createLobby(_loc3_);
      }
      
      private function onGameStarted(param1:Game2GameStartedMessageEvent) : void
      {
         var _loc2_:Game2GameStartedMessageParser = param1.getParser();
         HabboGamesCom.log("Game started!");
         UnknownVarFromIncomingMessages_SnowWarEngine_1.gameStarted(_loc2_.lobbyData);
      }
      ...
      private function onLobbyCounterStart(param1:Game2StartCounterMessageEvent) : void
      {
         ...
         UnknownVarFromIncomingMessages_SnowWarEngine_1.startLobbyCounter(_loc2_.countDownLength);
      }
      
      private function onLobbyCounterStop(param1:Game2StopCounterMessageEvent) : void
      {
         UnknownVarFromIncomingMessages_SnowWarEngine_1.stopLobbyCounter();
      }
      
      private function onGameCancelled(param1:Game2GameCancelledMessageEvent) : void
      {
         UnknownVarFromIncomingMessages_SnowWarEngine_1.gameCancelled(false);
      }
      ...
      private function onInArenaQueue(param1:Game2InArenaQueueMessageEvent) : void
      {
         ...
         if(UnknownVarFromIncomingMessages_SnowWarEngine_1.lobbyView)
         {
            UnknownVarFromIncomingMessages_SnowWarEngine_1.lobbyView.queuePosition = _loc2_.position;
         }
      }
      
      private function onUserJoined(param1:Game2UserJoinedGameMessageEvent) : void
      {
         var _loc2_:Game2UserJoinedGameMessageParser = param1.getParser();
         UnknownVarFromIncomingMessages_SnowWarEngine_1.userJoined(_loc2_.user);
      }
      ...
      private function onUserLeft(param1:Game2UserLeftGameMessageEvent) : void
      {
         ...
         UnknownVarFromIncomingMessages_SnowWarEngine_1.userLeft(_loc2_.userId);
      }
      
      private function onGameLongData(param1:Game2GameLongDataMessageEvent) : void
      {
         var _loc2_:Game2GameLongDataMessageParser = param1.getParser();
         var _loc3_:GameLobbyData = _loc2_.gameLobbyData;
      ...
      {
         UnknownVarFromIncomingMessages_SnowWarEngine_1.alert("${snowwar.error.generic}");
      }
      ...
      private function onPlayerBlockStatusChange(param1:Game2UserBlockedMessageEvent) : void
      {
         ...
         UnknownVarFromIncomingMessages_SnowWarEngine_1.mainView.changeBlockStatus(_loc2_.playerBlockLength);
      }
      
      private function onFullGameStatus(param1:Game2FullGameStatusMessageEvent) : void
      {
         var _loc4_:GameStatusData = null;
         var _loc3_:Game2FullGameStatusMessageParser = param1.getParser();
         var _loc2_:SynchronizedGameArena = UnknownVarFromIncomingMessages_SnowWarEngine_1.gameArena;
         HabboGamesCom.log("On full game status: ");
         var _loc5_:FullGameStatusData = _loc3_.fullStatus;
         (_loc2_.getCurrentStage() as SnowWarGameStage).resetTiles();
      ...
      {
         var _loc2_:Game2GameStatusMessageParser = param1.getParser();
      ...
      private function initializeGameObjects(param1:GameObjectsData) : void
      {
         ...
         var _loc10_:SynchronizedGameArena = UnknownVarFromIncomingMessages_SnowWarEngine_1.gameArena;
         if(!_loc10_)
         {
            return;
         }
         var _loc14_:SnowWarGameStage = _loc10_.getCurrentStage() as SnowWarGameStage;
         ...
         for each(var _loc2_ in param1.gameObjects)
         {
            switch(_loc2_.type - 1)
            {
               ...
               case 4:
                  ...
                  _loc8_ = _loc4_.name == UnknownVarFromIncomingMessages_SnowWarEngine_1.sessionDataManager.userName;
                  if(_loc8_)
                  {
                     UnknownVarFromIncomingMessages_SnowWarEngine_1.ownId = _loc4_.id;
                  }
                  _loc16_ = new HumanGameObject(_loc14_,_loc4_,false,UnknownVarFromIncomingMessages_SnowWarEngine_1);
                  _loc14_.addGameObject(_loc16_.gameObjectId,_loc16_);
                  _loc16_.visualizationMode = 0;
                  if(_loc8_ && UnknownVarFromIncomingMessages_SnowWarEngine_1.isGhostEnabled)
                  {
                     if(UnknownVarFromIncomingMessages_SnowWarEngine_1.isGhostVisualizationEnabled)
                     {
                     ...
                     if(UnknownVarFromIncomingMessages_SnowWarEngine_1.gameArena.getCurrentStage().getGameObject(_loc16_.ghostObjectId) == null)
                     {
                        _loc12_ = new HumanGameObject(_loc14_,_loc4_,true,UnknownVarFromIncomingMessages_SnowWarEngine_1);
      ...
      private function handleGameStatus(param1:GameStatusData, param2:Boolean = false) : void
      {
         ...
         var _loc4_:SynchronizedGameArena = UnknownVarFromIncomingMessages_SnowWarEngine_1.gameArena;
         if(!_loc4_)
         {
            return;
         }
         ...
         UnknownVarFromIncomingMessages_SnowWarEngine_1.nextTurn(_loc10_,_loc8_,param2);
      }
      ...
      {
         var _loc2_:SynchronizedGameArena = UnknownVarFromIncomingMessages_SnowWarEngine_1.gameArena;
         var _loc3_:SynchronizedGameStage = _loc2_.getCurrentStage();
      ...
      {
         var _loc3_:SynchronizedGameArena = UnknownVarFromIncomingMessages_SnowWarEngine_1.gameArena;
         var _loc4_:SynchronizedGameStage = _loc3_.getCurrentStage();
      ...
      private function handleGhostThrowSnowballAtPosition(param1:HumanThrowsSnowballAtPositionEventData) : HumanThrowsSnowballAtPositionEvent
      {
         ...
         var _loc3_:SynchronizedGameStage = null;
         if(UnknownVarFromIncomingMessages_SnowWarEngine_1.isGhostEnabled)
         {
            _loc2_ = UnknownVarFromIncomingMessages_SnowWarEngine_1.gameArena;
            _loc3_ = _loc2_.getCurrentStage();
            if(param1.humanGameObjectId == UnknownVarFromIncomingMessages_SnowWarEngine_1.ownId)
            {
               return new HumanThrowsSnowballAtPositionEvent(UnknownVarFromIncomingMessages_SnowWarEngine_1.getGhostPlayer(),param1.targetX,param1.targetY,param1.trajectory);
            }
         }
         return null;
      }
      ...
      private function handleGhostThrowSnowballAtHuman(param1:HumanThrowsSnowballAtHumanEventData) : HumanThrowsSnowballAtHumanEvent
      {
         ...
         var _loc4_:SynchronizedGameStage = null;
         var _loc2_:HumanGameObject = null;
         if(UnknownVarFromIncomingMessages_SnowWarEngine_1.isGhostEnabled)
         {
            _loc3_ = UnknownVarFromIncomingMessages_SnowWarEngine_1.gameArena;
            _loc4_ = _loc3_.getCurrentStage();
            _loc2_ = _loc4_.getGameObject(param1.targetHumanGameObjectId) as HumanGameObject;
            if(param1.humanGameObjectId == UnknownVarFromIncomingMessages_SnowWarEngine_1.ownId)
            {
               return new HumanThrowsSnowballAtHumanEvent(UnknownVarFromIncomingMessages_SnowWarEngine_1.getGhostPlayer(),_loc2_,param1.trajectory);
            }
         }
         return null;
      }
      ...
      private function handleGhostStartsToMakeASnowball(param1:HumanStartsToMakeASnowballEventData) : HumanStartsToMakeASnowballEvent
      {
         ...
         if(UnknownVarFromIncomingMessages_SnowWarEngine_1.isGhostEnabled)
         {
            ...
            if(param1.humanGameObjectId == UnknownVarFromIncomingMessages_SnowWarEngine_1.ownId)
            {
               return new HumanStartsToMakeASnowballEvent(UnknownVarFromIncomingMessages_SnowWarEngine_1.getGhostPlayer());
            }
         }
         return null;
      }
      ...
      {
         var _loc2_:Game2GameChatFromPlayerMessageParser = param1.getParser();
         if(UnknownVarFromIncomingMessages_SnowWarEngine_1 != null)
         {
            UnknownVarFromIncomingMessages_SnowWarEngine_1.addChatMessage(_loc2_.userId,_loc2_.chatMessage);
         }
      }
      ...
      private function onSubscriptionStatus(param1:ScrSendUserInfoEvent) : void
      {
         if(UnknownVarFromIncomingMessages_SnowWarEngine_1 != null)
         {
            UnknownVarFromIncomingMessages_SnowWarEngine_1.send(new Game2GetAccountGameStatusMessageComposer(0));
            if(UnknownVarFromIncomingMessages_SnowWarEngine_1.mainView.gameLobbyWindowActive)
            {
               return;
            }
            if(!UnknownVarFromIncomingMessages_SnowWarEngine_1.gameCenterEnabled)
            {
               UnknownVarFromIncomingMessages_SnowWarEngine_1.mainView.openMainWindow(false);
            }
         }
      }
      ...
      {
         UnknownVarFromIncomingMessages_SnowWarEngine_1.promoteGame();
      }
      ...
      private function onFriendsLeaderboard(param1:Game2FriendsLeaderboardEvent) : void
      {
         ...
         if(UnknownVarFromIncomingMessages_SnowWarEngine_1.leaderboard)
         {
            UnknownVarFromIncomingMessages_SnowWarEngine_1.leaderboard.addFriendAllTimeData(_loc2_.leaderboard,_loc2_.totalListSize);
         }
      }
      ...
      private function onTotalLeaderboard(param1:Game2TotalLeaderboardEvent) : void
      {
         ...
         if(UnknownVarFromIncomingMessages_SnowWarEngine_1.leaderboard)
         {
            UnknownVarFromIncomingMessages_SnowWarEngine_1.leaderboard.addAllTimeData(_loc2_.leaderboard,_loc2_.totalListSize);
         }
      }
      ...
      private function onTotalGroupLeaderboard(param1:Game2TotalGroupLeaderboardEvent) : void
      {
         ...
         if(UnknownVarFromIncomingMessages_SnowWarEngine_1.leaderboard)
         {
            UnknownVarFromIncomingMessages_SnowWarEngine_1.leaderboard.addAllTimeGroupData(_loc2_.leaderboard,_loc2_.totalListSize,_loc2_.favouriteGroupId);
         }
      }
      ...
      private function onWeeklyGroupLeaderboard(param1:Game2WeeklyGroupLeaderboardEvent) : void
      {
         ...
         if(UnknownVarFromIncomingMessages_SnowWarEngine_1.leaderboard)
         {
            UnknownVarFromIncomingMessages_SnowWarEngine_1.leaderboard.addWeeklyGroupData(_loc2_.year,_loc2_.week,_loc2_.leaderboard,_loc2_.totalListSize,_loc2_.maxOffset,_loc2_.minutesUntilReset,_loc2_.favouriteGroupId);
         }
      }
      ...
      private function onWeeklyLeaderboard(param1:Game2WeeklyLeaderboardEvent) : void
      {
         ...
         if(UnknownVarFromIncomingMessages_SnowWarEngine_1.leaderboard)
         {
            UnknownVarFromIncomingMessages_SnowWarEngine_1.leaderboard.addWeeklyData(_loc2_.year,_loc2_.week,_loc2_.leaderboard,_loc2_.totalListSize,_loc2_.maxOffset,_loc2_.minutesUntilReset);
         }
      }
      ...
      private function onWeeklyFriendsLeaderboard(param1:Game2WeeklyFriendsLeaderboardEvent) : void
      {
         ...
         if(UnknownVarFromIncomingMessages_SnowWarEngine_1.leaderboard)
         {
            UnknownVarFromIncomingMessages_SnowWarEngine_1.leaderboard.addFriendWeeklyData(_loc2_.year,_loc2_.week,_loc2_.leaderboard,_loc2_.totalListSize,_loc2_.maxOffset,_loc2_.minutesUntilReset);
         }
      }
   }
}
