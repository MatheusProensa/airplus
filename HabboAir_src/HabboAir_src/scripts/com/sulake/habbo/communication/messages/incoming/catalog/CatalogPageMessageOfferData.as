package com.sulake.habbo.communication.messages.incoming.catalog
{
   ...
   public class CatalogPageMessageOfferData
   {
      ...
      private var UnknownVarFromCatalogPageMessageOfferData_Boolean_1:Boolean;
      ...
      public function CatalogPageMessageOfferData(param1:IMessageDataWrapper)
      {
         ...
         _priceInSilver = param1.readInteger();
         ...
         UnknownVarFromCatalogPageMessageOfferData_Boolean_1 = param1.readBoolean();
         _previewImage = param1.readString();
      }
