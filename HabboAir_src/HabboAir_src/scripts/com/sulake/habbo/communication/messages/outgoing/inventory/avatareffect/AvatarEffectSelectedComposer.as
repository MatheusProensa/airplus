package com.sulake.habbo.communication.messages.outgoing.inventory.avatareffect
{
   ...
   {
      private var UnknownVarFromAvatarEffectSelectedComposer_Int_1:int;
      
      public function AvatarEffectSelectedComposer(param1:int)
      {
         super();
         UnknownVarFromAvatarEffectSelectedComposer_Int_1 = param1;
      }
      ...
      {
         var _loc1_:Array = [];
         _loc1_.push(UnknownVarFromAvatarEffectSelectedComposer_Int_1);
         return _loc1_;
      }
   }
}
