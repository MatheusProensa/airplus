package com.sulake.habbo.communication.messages.parser.game.snowwar.data.object
{
   ...
   {
      public static const UnknownConstFromHumanGameObjectData_Int_1:int = 19;
      ...
      override public function parse(param1:IMessageDataWrapper) : void
      {
         ...
         Logger.log("Parsed human game object data, variables:" + UnknownVarFromSnowWarGameObjectData_Array_1);
      }
