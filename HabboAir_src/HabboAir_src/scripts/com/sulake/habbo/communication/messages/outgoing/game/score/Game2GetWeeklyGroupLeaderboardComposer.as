package com.sulake.habbo.communication.messages.outgoing.game.score
{
   ...
   public class Game2GetWeeklyGroupLeaderboardComposer implements IMessageComposer
   {
      private var _messageArray:Array = [];
      
      public function Game2GetWeeklyGroupLeaderboardComposer(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int)
      {
         super();
