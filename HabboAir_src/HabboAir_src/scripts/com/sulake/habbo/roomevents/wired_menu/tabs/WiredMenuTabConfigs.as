package com.sulake.habbo.roomevents.wired_menu.tabs
{
   ...
   public class WiredMenuTabConfigs
   {
      ...
      public static var TAB_INSPECTION_ID:String = "inspection";
      
      public static var TAB_CHESTS_ID:String = "chests";
      
      public static var TAB_SETTINGS_ID:String = "settings";
      
      public static var TAB_INFO_ID:String = "info";
      
      private var _menuTabs:Vector.<WiredMenuTabConfig>;
      
      public function WiredMenuTabConfigs(param1:WiredMenuController)
      {
         super();
         _menuTabs = Vector.<WiredMenuTabConfig>([new WiredMenuTabConfig(TAB_MONITOR_ID,WiredMenuMonitorTab),new WiredMenuTabConfig(TAB_OVERVIEW_ID,WiredMenuOverviewTab),new WiredMenuTabConfig(TAB_INSPECTION_ID,WiredMenuInspectionTab),new WiredMenuTabConfig(TAB_CHESTS_ID,WiredMenuChestsTab),new WiredMenuTabConfig(TAB_SETTINGS_ID,WiredMenuSettingsTab),new WiredMenuTabConfig(TAB_INFO_ID,WiredMenuInfoTab,true,true,false)]);
      }
