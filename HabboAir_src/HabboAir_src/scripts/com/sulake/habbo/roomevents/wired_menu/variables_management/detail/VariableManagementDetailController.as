package com.sulake.habbo.roomevents.wired_menu.variables_management.detail
{
   ...
   import com.sulake.habbo.communication.messages.parser.userdefinedroomevents.wiredmenu.variables_management.WiredSetUserPermanentVariableResultMessageParser;
   ...
   import com.sulake.habbo.communication.messages.parser.userdefinedroomevents.wiredmenu.variables_management.WiredUserPermanentVariablesMessageParser;
   ...
   public class VariableManagementDetailController extends Component implements IVariableManagementDetailController
   {
      ...
      private var _view:VariableManagementDetailView;
      
      private var _data:WiredUserPermanentVariablesList;
      
      private var _variablesById:Dictionary = new Dictionary();
      
      public function VariableManagementDetailController(param1:HabboUserDefinedRoomEvents, param2:IComponent_2, param3:uint = 0, param4:IAssetLibraryCollection = null)
      {
      ...
      private function onGetData(param1:WiredUserPermanentVariablesEvent) : void
      {
         ...
         var parser:WiredUserPermanentVariablesMessageParser = event.getParser();
      ...
      {
         _data = param2;
         _variablesById = new Dictionary();
         for each(var _loc3_ in param1)
         {
            _variablesById[_loc3_.variableId] = _loc3_;
         }
         dataIsReady();
      }
      ...
      private function dataIsReady() : void
      {
         if(_view == null)
         {
            _view = new VariableManagementDetailView(this,_windowManager);
         }
      ...
      {
         var _loc2_:WiredSetUserPermanentVariableResultMessageParser = param1.getParser();
