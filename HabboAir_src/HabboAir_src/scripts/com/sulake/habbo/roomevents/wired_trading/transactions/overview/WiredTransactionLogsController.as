package com.sulake.habbo.roomevents.wired_trading.transactions.overview
{
   ...
   import com.sulake.habbo.roomevents.wired_menu.tabs.tab_chests.WiredMenuChestsTab;
   ...
   public class WiredTransactionLogsController extends Component implements UnknownIHabboRoomeventsWired_TradingTransactionsOverview1
   {
      ...
      public function WiredTransactionLogsController(param1:HabboUserDefinedRoomEvents, param2:IComponent_2, param3:uint = 0, param4:IAssetLibraryCollection = null)
      {
         super(param2,param3,param4);
         _roomEvents = param1;
         _messageEvents = new Vector.<IMessageEvent>();
         _messageEvents.push(new WiredTransactionLogListMessageEvent(onLogList));
      ...
      private function onLogList(param1:WiredTransactionLogListMessageEvent) : void
      {
         var _loc2_:WiredTransactionLogListMessageParser = param1.getParser();
         if(_loc2_.logs.amount == WiredMenuChestsTab.TRANSACTIONS_PREVIEW_AMOUNT)
         {
            return;
         }
         if(_loc2_.logs.amount != TransactionConfig.PAGE_SIZE)
         {
            return;
         }
         _logs = _loc2_.logs;
         if(_view == null)
         {
            _view = new WiredTransactionLogsView(this,_windowManager);
         }
      ...
      public function get view() : WiredTransactionLogsView
      {
         return _view;
      }
