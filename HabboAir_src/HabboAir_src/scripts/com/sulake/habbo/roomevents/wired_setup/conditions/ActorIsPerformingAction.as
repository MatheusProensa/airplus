package com.sulake.habbo.roomevents.wired_setup.conditions
{
   ...
   public class ActorIsPerformingAction extends DefaultConditionType
   {
      ...
      private var UnknownVarFromActorIsPerformingAction_CheckboxGroupPreset_1:CheckboxGroupPreset;
      
      private var UnknownVarFromActorIsPerformingAction_CheckboxGroupPreset_2:CheckboxGroupPreset;
      
      private var _signDropdown:DropdownPreset;
      
      private var _danceDropdown:DropdownPreset;
      
      private var UnknownVarFromActorIsPerformingAction_SectionPreset_1:SectionPreset;
      
      private var UnknownVarFromActorIsPerformingAction_SectionPreset_2:SectionPreset;
      ...
      override public function buildInputs(param1:PresetManager, param2:WiredStyle, param3:WiredUIBuilder) : void
      {
         ...
         UnknownVarFromActorIsPerformingAction_CheckboxGroupPreset_1 = param1.createCheckboxGroup([_loc6_]);
         UnknownVarFromActorIsPerformingAction_SectionPreset_1 = param1.createSection(l("sign_selection"),UnknownVarFromActorIsPerformingAction_CheckboxGroupPreset_1);
         ...
         UnknownVarFromActorIsPerformingAction_CheckboxGroupPreset_2 = param1.createCheckboxGroup([_loc5_]);
         UnknownVarFromActorIsPerformingAction_SectionPreset_2 = param1.createSection(l("dance_selection"),UnknownVarFromActorIsPerformingAction_CheckboxGroupPreset_2);
         UnknownVarFromActorIsPerformingAction_SectionPreset_1.visible = false;
         UnknownVarFromActorIsPerformingAction_SectionPreset_2.visible = false;
         param3.addElements(_loc4_,UnknownVarFromActorIsPerformingAction_SectionPreset_1,UnknownVarFromActorIsPerformingAction_SectionPreset_2);
      }
      ...
      private function updateExtraSections(param1:String = "") : void
      {
         ...
         UnknownVarFromActorIsPerformingAction_SectionPreset_1.visible = _loc4_;
         UnknownVarFromActorIsPerformingAction_SectionPreset_2.visible = _loc3_;
         if(_loc4_)
         {
            if(param1 == "")
            {
               UnknownVarFromActorIsPerformingAction_CheckboxGroupPreset_1.get(0).selected = false;
               _signDropdown.selectedId = -1;
            }
            else
            {
               UnknownVarFromActorIsPerformingAction_CheckboxGroupPreset_1.get(0).selected = true;
         ...
         if(_loc3_)
         {
            if(param1 == "")
            {
               UnknownVarFromActorIsPerformingAction_CheckboxGroupPreset_2.get(0).selected = false;
               _danceDropdown.selectedId = -1;
            }
            else
            {
               UnknownVarFromActorIsPerformingAction_CheckboxGroupPreset_2.get(0).selected = true;
      ...
      private function getSelectedExtraCode(param1:int) : int
      {
         if(param1 == 10)
         {
            return UnknownVarFromActorIsPerformingAction_CheckboxGroupPreset_1.get(0).selected ? _signDropdown.selectedId : -1;
         }
         if(param1 == 11)
         {
            return UnknownVarFromActorIsPerformingAction_CheckboxGroupPreset_2.get(0).selected ? _danceDropdown.selectedId : -1;
         }
         return -1;
      }
