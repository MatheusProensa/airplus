package com.sulake.habbo.roomevents.wired_setup.selectors
{
   ...
   public class UsersPerformingAction extends DefaultSelectorType
   {
      ...
      private var UnknownVarFromUsersPerformingAction_CheckboxGroupPreset_1:CheckboxGroupPreset;
      
      private var UnknownVarFromUsersPerformingAction_CheckboxGroupPreset_2:CheckboxGroupPreset;
      
      private var _signDropdown:DropdownPreset;
      
      private var _danceDropdown:DropdownPreset;
      
      private var UnknownVarFromUsersPerformingAction_SectionPreset_1:SectionPreset;
      
      private var UnknownVarFromUsersPerformingAction_SectionPreset_2:SectionPreset;
      
      public function UsersPerformingAction()
      {
         super();
      }
      ...
      {
         return SelectorCodes.USERS_PERFORMING_ACTION;
      }
      ...
      override public function buildInputs(param1:PresetManager, param2:WiredStyle, param3:WiredUIBuilder) : void
      {
         ...
         UnknownVarFromUsersPerformingAction_CheckboxGroupPreset_1 = param1.createCheckboxGroup([_loc6_]);
         UnknownVarFromUsersPerformingAction_SectionPreset_1 = param1.createSection(l("sign_selection"),UnknownVarFromUsersPerformingAction_CheckboxGroupPreset_1);
         ...
         UnknownVarFromUsersPerformingAction_CheckboxGroupPreset_2 = param1.createCheckboxGroup([_loc5_]);
         UnknownVarFromUsersPerformingAction_SectionPreset_2 = param1.createSection(l("dance_selection"),UnknownVarFromUsersPerformingAction_CheckboxGroupPreset_2);
         UnknownVarFromUsersPerformingAction_SectionPreset_1.visible = false;
         UnknownVarFromUsersPerformingAction_SectionPreset_2.visible = false;
         param3.addElements(_loc4_,UnknownVarFromUsersPerformingAction_SectionPreset_1,UnknownVarFromUsersPerformingAction_SectionPreset_2);
      }
      ...
      private function updateExtraSections(param1:String = "") : void
      {
         ...
         UnknownVarFromUsersPerformingAction_SectionPreset_1.visible = _loc4_;
         UnknownVarFromUsersPerformingAction_SectionPreset_2.visible = _loc3_;
         if(_loc4_)
         {
            if(param1 == "")
            {
               UnknownVarFromUsersPerformingAction_CheckboxGroupPreset_1.get(0).selected = false;
               _signDropdown.selectedId = -1;
            }
            else
            {
               UnknownVarFromUsersPerformingAction_CheckboxGroupPreset_1.get(0).selected = true;
         ...
         if(_loc3_)
         {
            if(param1 == "")
            {
               UnknownVarFromUsersPerformingAction_CheckboxGroupPreset_2.get(0).selected = false;
               _danceDropdown.selectedId = -1;
            }
            else
            {
               UnknownVarFromUsersPerformingAction_CheckboxGroupPreset_2.get(0).selected = true;
      ...
      private function getSelectedExtraCode(param1:int) : int
      {
         if(param1 == 10)
         {
            return UnknownVarFromUsersPerformingAction_CheckboxGroupPreset_1.get(0).selected ? _signDropdown.selectedId : -1;
         }
         if(param1 == 11)
         {
            return UnknownVarFromUsersPerformingAction_CheckboxGroupPreset_2.get(0).selected ? _danceDropdown.selectedId : -1;
         }
         return -1;
      }
