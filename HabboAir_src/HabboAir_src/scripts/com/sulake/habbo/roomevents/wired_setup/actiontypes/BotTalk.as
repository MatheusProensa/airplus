package com.sulake.habbo.roomevents.wired_setup.actiontypes
{
   ...
   public class BotTalk extends UnknownHabboRoomeventsWired_SetupActiontypes1
   {
      ...
      private var UnknownVarFromBotTalk_RadioGroupPreset_1:RadioGroupPreset;
      ...
      override public function onEditStart(param1:Triggerable) : void
      {
         ...
         UnknownVarFromBotTalk_RadioGroupPreset_1.selected = param1.intParams[0];
      }
      
      override public function readIntParamsFromForm() : Array
      {
         return [UnknownVarFromBotTalk_RadioGroupPreset_1.selected];
      }
      ...
      override public function buildInputs(param1:PresetManager, param2:WiredStyle, param3:WiredUIBuilder) : void
      {
         ...
         UnknownVarFromBotTalk_RadioGroupPreset_1 = param1.createRadioGroup([new RadioButtonParam(0,l("talk")),new RadioButtonParam(1,l("shout"))]);
         var _loc5_:SimpleListViewPreset = param1.createSimpleListView(true,[_chatMessage,UnknownVarFromBotTalk_RadioGroupPreset_1]);
