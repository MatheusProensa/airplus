package com.sulake.habbo.roomevents.wired_setup.uibuilder.styles
{
   ...
   public class VolterGreenWiredStyle extends WiredStyle
   {
      public static const NAME:String = "volter_green";
      
      private var _styleTemplate:IWindowController_1;
      
      public function VolterGreenWiredStyle(param1:HabboUserDefinedRoomEvents)
      {
         super(param1);
         _styleTemplate = IWindowController_1(param1.getXmlWindow("wired_style_volter_green"));
      }
