package com.sulake.habbo.roomevents.wired_setup.variables
{
   ...
   public class QuestVariable extends NewDefaultVariableType
   {
      ...
      {
         return VariableCodes.UnknownVarFromVariableCodes_Int_2;
      }
      ...
      override public function onEditStart(param1:Triggerable) : void
      {
         ...
         _questName.text = _loc2_.length > 1 ? _loc2_[1] : "";
      }
      
      override public function readStringParamFromForm() : String
      {
         return _variableName.variableName + STRING_PARAM_SPLITTER + _questName.text;
      }
      ...
      override public function buildInputs(param1:PresetManager, param2:WiredStyle, param3:WiredUIBuilder) : void
      {
         ...
         _questName = param1.createTextInput(new TextInputParam("",500));
         var _loc4_:SectionPreset = param1.createSection(l("variables.quest_name"),_questName);
