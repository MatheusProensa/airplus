package com.sulake.habbo.freeflowchat.history.visualization.entry
{
   ...
   public class ChatHistoryRoomChangeEntry implements IChatHistoryEntryBitmapBubble
   {
      ...
      public function ChatHistoryRoomChangeEntry(param1:GuestRoomData, param2:HabboFreeFlowChat)
      {
         super();
         var _loc4_:TextField = new TextField();
         _loc4_.defaultTextFormat = UnknownHabboFreeflowchatHistoryVisualizationEnum1.TEXT_FORMAT;
         _loc4_.htmlText = param1?.roomName;
         ...
         _loc3_.defaultTextFormat = UnknownHabboFreeflowchatHistoryVisualizationEnum1.TEXT_FORMAT_TIMESTAMP;
