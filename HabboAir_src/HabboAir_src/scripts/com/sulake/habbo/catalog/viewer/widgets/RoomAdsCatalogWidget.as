package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RoomAdsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var UnknownVarFromRoomAdsCatalogWidget_IMessageEvent_1:IMessageEvent = null;
      ...
      private var UnknownVarFromRoomAdsCatalogWidget_Boolean_1:Boolean;
      
      private var UnknownVarFromRoomAdsCatalogWidget_IDropBaseController_1_1:IDropBaseController_1;
      
      public function RoomAdsCatalogWidget(param1:IWindowController_1, param2:HabboCatalog)
      {
         super(param1);
         _catalog = param2;
      }
      ...
      override public function init() : Boolean
      {
         ...
         if(UnknownVarFromRoomAdsCatalogWidget_IMessageEvent_1 == null)
         {
            UnknownVarFromRoomAdsCatalogWidget_IMessageEvent_1 = new RoomAdPurchaseInfoEvent(onPurchaseInfoEvent);
            _loc4_.addMessageEvent(UnknownVarFromRoomAdsCatalogWidget_IMessageEvent_1);
         }
      ...
      private function populateEventCategories() : void
      {
         ...
         UnknownVarFromRoomAdsCatalogWidget_IDropBaseController_1_1 = window.findChildByName("categories_list") as IDropBaseController_1;
         var _loc2_:Array = [];
         ...
         UnknownVarFromRoomAdsCatalogWidget_IDropBaseController_1_1.populate(_loc2_);
         UnknownVarFromRoomAdsCatalogWidget_IDropBaseController_1_1.selection = 0;
         UnknownVarFromRoomAdsCatalogWidget_IDropBaseController_1_1.addEventListener("WE_SELECTED",onEventCategoryMenuEvent);
      }
      ...
      private function setDefaultRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc8_:IDropBaseController_1 = window.findChildByName("room_drop_menu") as IDropBaseController_1;
         if(_rooms == null)
         {
         ...
         {
            _loc3_ = _rooms[_loc6_] as RoomEntryData;
            if(param2)
            {
         ...
         var _loc10_:RoomEntryData = _rooms[_loc5_] as RoomEntryData;
         if(_loc10_ != null)
         {
            _loc8_.selection = _loc5_;
            _loc7_ = _catalog.roomAdPurchaseData;
            if(_loc7_ == null)
            {
      ...
      private function setExtendData() : void
      {
         ...
         if(_loc2_ != null && _loc2_.extended)
         {
            ...
            _loc1_ = new RoomEntryData(_loc2_.flatId,_loc2_.roomName,false);
            if(_rooms != null)
            {
               _rooms.push(_loc1_);
            }
            if(UnknownVarFromRoomAdsCatalogWidget_IDropBaseController_1_1 == null)
            {
               UnknownVarFromRoomAdsCatalogWidget_IDropBaseController_1_1 = window.findChildByName("categories_list") as IDropBaseController_1;
            }
            UnknownVarFromRoomAdsCatalogWidget_IDropBaseController_1_1.selection = _loc2_.categoryId - 1;
         }
      }
      ...
      public function onPurchaseInfoEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc6_:IDropBaseController_1 = window.findChildByName("room_drop_menu") as IDropBaseController_1;
         _rooms = _loc3_.rooms;
         UnknownVarFromRoomAdsCatalogWidget_Boolean_1 = _loc3_.isVip;
         var _loc8_:int = _catalog.roomEngine.activeRoomId;
         setExtendData();
         populateEventCategories();
         setDefaultRoom(_loc8_,true);
         var _loc2_:UnknownIHabboCatalog1 = selectedOffer();
         if(_loc2_ != null)
         {
            events.dispatchEvent(new SelectProductEvent(_loc2_));
            _loc5_ = _catalog.roomAdPurchaseData;
            if(_loc5_ == null)
            {
            ...
            _catalog.roomAdPurchaseData = _loc5_;
            _loc4_ = window.findChildByName("price_container") as IWindowController_1;
      ...
      private function onRoomDropMenuEvent(param1:WindowEvent, param2:IWindowModel) : void
      {
         var _loc5_:int = 0;
         ...
         {
            _loc5_ = int(IDropBaseController_1(param2).selection);
            _loc4_ = _rooms[_loc5_] as RoomEntryData;
      ...
      private function onEventCategoryMenuEvent(param1:WindowEvent) : void
      {
         var _loc3_:int = 0;
         var _loc5_:int = -1;
         var _loc6_:int = UnknownVarFromRoomAdsCatalogWidget_IDropBaseController_1_1.selection;
      ...
      private function selectedOffer() : UnknownIHabboCatalog1
      {
         var _loc3_:int = 0;
         var _loc2_:Offer = null;
         var _loc1_:Vector.<UnknownIHabboCatalog1> = page.offers;
         if(_loc1_ != null && _loc1_)
         {
            ...
            while(_loc3_ < _loc1_.length)
            {
               ...
               if(_loc2_.clubLevel == 2 && UnknownVarFromRoomAdsCatalogWidget_Boolean_1 || _loc2_.clubLevel != 2 && !UnknownVarFromRoomAdsCatalogWidget_Boolean_1)
               {
                  return _loc2_;
               }
               _loc3_++;
      ...
      override public function dispose() : void
      {
         ...
         if(_catalog != null)
         {
            ...
            if(UnknownVarFromRoomAdsCatalogWidget_IMessageEvent_1 != null)
            {
               _loc1_.removeMessageEvent(UnknownVarFromRoomAdsCatalogWidget_IMessageEvent_1);
               UnknownVarFromRoomAdsCatalogWidget_IMessageEvent_1 = null;
            }
