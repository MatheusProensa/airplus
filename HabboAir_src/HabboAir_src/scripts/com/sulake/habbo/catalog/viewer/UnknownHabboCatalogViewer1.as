package com.sulake.habbo.catalog.viewer
{
   ...
   public class UnknownHabboCatalogViewer1
   {
      ...
      PRODUCT_IMAGES["GET_SNOWWAR_TOKENS"] = "snowwar_tokens_10";
      PRODUCT_IMAGES["GET_SNOWWAR_TOKENS2"] = "snowwar_tokens_10";
      PRODUCT_IMAGES["GET_SNOWWAR_TOKENS3"] = "snowwar_tokens_10";
      PRODUCT_IMAGES["room_ad_plus_badge"] = "events_confirm_purchase";
      
      public function UnknownHabboCatalogViewer1()
      {
         super();
      }
      ...
      {
         return PRODUCT_IMAGES[param1] != null;
      }
   }
}
