package com.sulake.habbo.room.utils
{
   ...
   public class SpriteDataCollector
   {
      ...
      private var UnknownVarFromSpriteDataCollector_Number_1:Number;
      
      private var spriteCount:int = 0;
      
      private var externalImageCount:int = 0;
      
      public function SpriteDataCollector()
      {
         super();
      }
      ...
      public function getFurniData(param1:Rectangle, param2:IRoomRenderingCanvas, param3:RoomEngine, param4:int) : String
      {
         ...
         for each(var _loc5_ in _loc6_)
         {
            if(_loc5_.name != null && _loc5_.name.length > 0 && _loc5_.name.indexOf("tile_cursor_") != 0 && isSpriteInViewPort(_loc5_,param1,param2) && (param4 < 0 || _loc5_.objectId != param4))
            {
               ...
               if(!UnknownVarFromSpriteDataCollector_Number_1)
               {
                  UnknownVarFromSpriteDataCollector_Number_1 = _loc5_.z;
               }
               spriteCount++;
            }
         }
      ...
      private function getSpriteDataObject(param1:RoomObjectSpriteData, param2:Rectangle, param3:IRoomRenderingCanvas, param4:RoomEngine) : Object
      {
         ...
         var _loc6_:IGraphicAssetCollection = null;
      ...
      private function makeBackgroundPlane(param1:Rectangle, param2:uint, param3:Array) : IRoomObjectSprite_1
      {
         ...
         if(param3.length > 0)
         {
            ...
            if(UnknownVarFromSpriteDataCollector_Number_1)
            {
               _loc4_ = Math.max(UnknownVarFromSpriteDataCollector_Number_1,_loc4_);
            }
         }
         else
         {
            _loc4_ = !!UnknownVarFromSpriteDataCollector_Number_1 ? UnknownVarFromSpriteDataCollector_Number_1 : 0;
         }
         _loc4_ += spriteCount * 1.776104 + param3.length * 2.31743;
         var _loc5_:IRoomObjectSprite_1 = new PlaneDrawingData(null,param2);
      ...
      private function sortRoomPlanes(param1:Vector.<IRoomPlane>, param2:IRoomRenderingCanvas, param3:RoomEngine) : Array
      {
         ...
         if(UnknownVarFromSpriteDataCollector_Number_1)
         {
            _loc10_ += UnknownVarFromSpriteDataCollector_Number_1;
         }
      ...
      public function getRoomPlanes(param1:Rectangle, param2:IRoomRenderingCanvas, param3:RoomEngine, param4:uint) : Array
      {
         ...
         var _loc7_:UnknownIRoomObjectVisualization1 = _loc18_.getVisualization() as UnknownIRoomObjectVisualization1;
         if(_loc7_)
         {
            _loc20_ = param2.geometry;
            _loc12_ = sortRoomPlanes(_loc7_.planes,param2,param3);
            _loc17_ = Core.instance.displayObjectContainer.stage;
