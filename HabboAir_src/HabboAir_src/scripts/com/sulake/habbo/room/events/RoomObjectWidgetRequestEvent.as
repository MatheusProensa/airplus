package com.sulake.habbo.room.events
{
   ...
   public class RoomObjectWidgetRequestEvent extends RoomObjectEvent
   {
      ...
      public static const UnknownConstFromRoomObjectWidgetRequestEvent_String_1:String = "ROWRE_PURCHASABLE_CLOTHING_CONFIRMATION_DIALOG";
      
      public static const BACKGROUND_COLOR:String = "ROWRE_BACKGROUND_COLOR";
      
      public static const UnknownConstFromRoomObjectWidgetRequestEvent_String_2:String = "ROWRE_HIDE_AREA";
      
      public static const MYSTERYBOX_OPEN_DIALOG:String = "ROWRE_MYSTERYBOX_OPEN_DIALOG";
      
      public static const UnknownConstFromRoomObjectWidgetRequestEvent_String_3:String = "ROWRE_EFFECTBOX_OPEN_DIALOG";
      ...
      public static const UnknownConstFromRoomWidgetEnum_String_4:String = "ROWRE_HIGH_SCORE_DISPLAY";
      
      public static const UnknownConstFromRoomObjectWidgetRequestEvent_String_4:String = "ROWRE_HIDE_HIGH_SCORE_DISPLAY";
