package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class WallRasterizer extends PlaneRasterizer
   {
      ...
      protected function parseWalls(param1:XML) : void
      {
         ...
         var _loc7_:UnknownHabboRoomObjectVisualizationRoomRasterizerBasic2 = null;
         if(param1 == null)
         {
            return;
         }
         ...
         while(_loc5_ < _loc3_.length())
         {
            ...
            if(UnknownRoomUtils1.checkRequiredAttributes(_loc2_,["id"]))
            {
               _loc6_ = _loc2_.@id;
               _loc4_ = _loc2_.visualization;
               _loc7_ = new UnknownHabboRoomObjectVisualizationRoomRasterizerBasic2();
      ...
      {
         var _loc15_:UnknownHabboRoomObjectVisualizationRoomRasterizerBasic2 = getPlane(param2) as UnknownHabboRoomObjectVisualizationRoomRasterizerBasic2;
         if(_loc15_ == null)
         {
            _loc15_ = getPlane("default") as UnknownHabboRoomObjectVisualizationRoomRasterizerBasic2;
         }
         if(_loc15_ == null)
         {
            return null;
         ...
         var _loc14_:BitmapData = _loc15_.render(param1,param3,param4,param5,param6,param7);
