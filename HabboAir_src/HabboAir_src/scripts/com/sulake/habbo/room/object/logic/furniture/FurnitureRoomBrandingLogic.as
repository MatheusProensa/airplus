package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomBrandingLogic extends FurnitureLogic
   {
      ...
      protected var UnknownVarFromFurnitureRoomBrandingLogic_Boolean_1:Boolean;
      
      protected var UnknownVarFromFurnitureRoomBrandingLogic_Boolean_2:Boolean;
      
      public function FurnitureRoomBrandingLogic()
      {
         super();
         UnknownVarFromFurnitureRoomBrandingLogic_Boolean_1 = true;
         UnknownVarFromFurnitureRoomBrandingLogic_Boolean_2 = false;
      }
      
      override public function initialize(param1:XML) : void
      {
         super.initialize(param1);
         if(UnknownVarFromFurnitureRoomBrandingLogic_Boolean_1)
         {
      ...
      private function setupImageFromFurnitureData() : Boolean
      {
         ...
         if(object != null)
         {
            _loc9_ = new MapStuffData();
            _loc9_.initializeFromRoomObjectModel(object.getModel());
            _loc2_ = 0;
            if(!isNaN(_loc2_))
            {
               _loc12_ = _loc2_;
            ...
            _loc14_ = forceImageUrlToUseHttps(_loc9_.getValue("imageUrl"));
            if(_loc14_ != null)
            {
            ...
            _loc4_ = _loc9_.getValue("clickUrl");
            if(_loc4_ != null)
            {
               _loc5_ = object.getModelController().getString("furniture_branding_url");
         ...
         var _loc11_:String = "imageUrl=" + (_loc10_ ?? "") + "\t";
         if(UnknownVarFromFurnitureRoomBrandingLogic_Boolean_2)
         {
            _loc11_ += "clickUrl=" + (_loc1_ ?? "") + "\t";
         }
         _loc11_ += "offsetX=" + _loc6_ + "\t";
         _loc11_ = _loc11_ + ("offsetY=" + _loc8_ + "\t");
         _loc11_ = _loc11_ + ("offsetZ=" + _loc7_ + "\t");
