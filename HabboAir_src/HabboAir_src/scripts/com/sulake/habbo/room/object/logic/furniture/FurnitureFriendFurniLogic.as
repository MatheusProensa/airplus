package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureFriendFurniLogic extends FurnitureMultiStateLogic
   {
      ...
      private var UnknownVarFromFurnitureFriendFurniLogic_Int_1:int = -1;
      ...
      {
         return UnknownVarFromFurnitureFriendFurniLogic_Int_1 == 0 ? "FRIEND_FURNITURE" : "DUMMY";
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               UnknownVarFromFurnitureFriendFurniLogic_Int_1 = _loc2_.state;
            }
            else
            {
               UnknownVarFromFurnitureFriendFurniLogic_Int_1 = _loc3_.state;
            }
         }
      ...
      override public function useObject() : void
      {
         ...
         {
            if(UnknownVarFromFurnitureFriendFurniLogic_Int_1 == 1)
            {
