package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class UnknownHabboRoomObjectLogicFurniture1 extends FurnitureMultiStateLogic
   {
      public function UnknownHabboRoomObjectLogicFurniture1()
      {
         super();
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         {
            _loc4_ = _loc3_[0];
            if(UnknownRoomUtils1.checkRequiredAttributes(_loc4_,["type"]))
            {
               _loc2_ = _loc4_.@type;
