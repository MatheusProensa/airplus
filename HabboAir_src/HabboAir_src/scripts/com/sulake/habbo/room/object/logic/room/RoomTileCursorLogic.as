package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomTileCursorLogic extends ObjectLogicBase
   {
      ...
      private var UnknownVarFromRoomTileCursorLogic_String_1:String;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(UnknownVarFromRoomTileCursorLogic_String_1 != null && UnknownVarFromRoomTileCursorLogic_String_1 == _loc2_.sourceEventId)
         {
            return;
         }
         ...
         UnknownVarFromRoomTileCursorLogic_String_1 = _loc2_.sourceEventId;
      }
   }
}
