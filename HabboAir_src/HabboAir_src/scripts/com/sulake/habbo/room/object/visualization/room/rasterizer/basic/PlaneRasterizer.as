package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   import com.sulake.room.utils.UnknownRoomUtils2;
   import com.sulake.room.utils.Vector3d;
   import flash.display.BitmapData;
   import flash.geom.Point;
   
   public class PlaneRasterizer implements UnknownIHabboRoomObjectVisualizationRoomRasterizer1
   {
      ...
      public function dispose() : void
      {
         ...
         if(_planes != null)
         {
            ...
            {
               _loc1_ = _planes.getWithIndex(_loc2_) as Plane;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < _geometries.length)
            {
               _loc3_ = _geometries.getWithIndex(_loc2_);
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function clearCache() : void
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = 0;
         while(_loc3_ < _planes.length)
         {
            _loc1_ = _planes.getWithIndex(_loc3_) as Plane;
            if(_loc1_ != null)
            {
               _loc1_.clearCache();
            }
      ...
      private function resetTextures() : void
      {
         ...
         {
            _loc1_ = _textures.getWithIndex(_loc2_) as PlaneTexture;
            if(_loc1_ != null)
            {
               _loc1_.dispose();
            }
      ...
      {
         return _textures.getValue(param1) as PlaneTexture;
      }
      ...
      {
         return _planes.getValue(param1);
      }
      ...
      protected function addPlane(param1:String, param2:Plane) : Boolean
      {
         ...
         if(_planes.getValue(param1) == null)
         {
            _planes.add(param1,param2);
            return true;
         }
         return false;
      }
      ...
      private function parseTextures(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc7_ < _loc5_.length())
         {
            ...
            if(UnknownRoomUtils1.checkRequiredAttributes(_loc6_,["id"]))
            {
               _loc16_ = _loc6_.@id;
               if(_textures.getValue(_loc16_) == null)
               {
                  ...
                  while(_loc9_ < _loc3_.length())
                  {
                     ...
                     if(UnknownRoomUtils1.checkRequiredAttributes(_loc13_,["assetName"]))
                     {
                        _loc8_ = -1;
                        _loc18_ = 1;
                        _loc10_ = -1;
                        ...
                        _loc17_ = param2.getAsset(_loc15_);
                        if(_loc17_ != null)
                        {
                           _loc11_ = _loc17_.asset as BitmapDataAsset;
                           if(_loc11_ != null)
                           {
                              ...
                              if(_loc12_ != null)
                              {
                                 if(_loc17_.flipH)
                                 {
                                    _loc12_ = UnknownRoomUtils2.getFlipHBitmapData(_loc12_);
                                 }
                                 else
                                 {
      ...
      private function parsePlaneMaterials(param1:XML) : void
      {
         ...
         while(_loc4_ < _loc17_.length())
         {
            ...
            if(UnknownRoomUtils1.checkRequiredAttributes(_loc15_,["id"]))
            {
               _loc20_ = _loc15_.@id;
               ...
               while(_loc6_ < _loc2_.length())
               {
                  ...
                  _loc18_ = _loc11_.materialCellColumn;
                  if(_loc18_.length() > 0)
                  {
                     _loc13_ = null;
      ...
      private function parsePlaneMaterialCells(param1:XML) : Array
      {
         ...
         {
            _loc13_ = _loc17_[_loc6_];
            _loc8_ = _loc13_.@textureId;
            _loc20_ = null;
            _loc21_ = null;
            _loc2_ = null;
            _loc14_ = 0;
            ...
            {
               _loc10_ = _loc3_[0];
               _loc18_ = _loc10_.extraItemTypes;
            ...
            if(_loc20_ != null)
            {
               ...
               {
                  _loc16_ = _loc20_[_loc6_];
                  _loc19_ = _assetCollection.getAsset(_loc16_);
                  if(_loc19_ != null)
                  {
      ...
      private function parseExtraItemTypes(param1:XML) : Array
      {
         ...
         if(param1 != null)
         {
            ...
            while(_loc4_ < _loc3_.length())
            {
               ...
               if(UnknownRoomUtils1.checkRequiredAttributes(_loc5_,_loc7_))
               {
      ...
      private function parseExtraItemOffsets(param1:XML) : Array
      {
         ...
         if(param1 != null)
         {
            ...
            while(_loc6_ < _loc4_.length())
            {
               ...
               if(UnknownRoomUtils1.checkRequiredAttributes(_loc3_,_loc8_))
               {
      ...
      protected function getGeometry(param1:int, param2:Number, param3:Number) : IRoomGeometry
      {
         ...
         var _loc4_:IRoomGeometry = _geometries.getValue(_loc5_);
         if(_loc4_ == null)
         {
            _loc4_ = new RoomGeometry(param1,new Vector3d(param2,param3),new Vector3d(-10,0,0));
            _geometries.add(_loc5_,_loc4_);
         }
         return _loc4_;
      }
      ...
      protected function parseVisualizations(param1:Plane, param2:XMLList) : void
      {
         ...
         while(_loc8_ < param2.length())
         {
            ...
            if(UnknownRoomUtils1.checkRequiredAttributes(_loc3_,["size"]))
            {
               ...
               _loc7_ = param1.createPlaneVisualization(_loc16_,_loc19_.length(),getGeometry(_loc16_,_loc18_,_loc14_));
               if(_loc7_ != null)
               {
                  _loc10_ = 0;
                  while(_loc10_ < _loc19_.length())
                  {
                     ...
                     _loc17_ = null;
                     _loc11_ = 1;
                     if(UnknownRoomUtils1.checkRequiredAttributes(_loc13_,["materialId"]))
                     {
