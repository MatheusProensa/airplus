package com.sulake.habbo.room.object.logic.room
{
   ...
   {
      protected var UnknownVarFromRoomLogic_RoomPlaneParser_1:RoomPlaneParser = null;
      
      private var UnknownVarFromRoomLogic_RoomPlaneBitmapMaskParser_1:RoomPlaneBitmapMaskParser = null;
      
      private var UnknownVarFromRoomLogic_ColorTransitioner_1:ColorTransitioner = null;
      
      private var UnknownVarFromRoomLogic_Boolean_1:Boolean;
      
      public function RoomLogic()
      {
         super();
         UnknownVarFromRoomLogic_RoomPlaneParser_1 = new RoomPlaneParser();
         UnknownVarFromRoomLogic_RoomPlaneBitmapMaskParser_1 = new RoomPlaneBitmapMaskParser();
         UnknownVarFromRoomLogic_ColorTransitioner_1 = new ColorTransitioner();
      }
      ...
      {
         super.dispose();
         if(UnknownVarFromRoomLogic_RoomPlaneParser_1 != null)
         {
            UnknownVarFromRoomLogic_RoomPlaneParser_1.dispose();
            UnknownVarFromRoomLogic_RoomPlaneParser_1 = null;
         }
         if(UnknownVarFromRoomLogic_RoomPlaneBitmapMaskParser_1 != null)
         {
            UnknownVarFromRoomLogic_RoomPlaneBitmapMaskParser_1.dispose();
            UnknownVarFromRoomLogic_RoomPlaneBitmapMaskParser_1 = null;
         }
         UnknownVarFromRoomLogic_ColorTransitioner_1 = null;
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(!UnknownVarFromRoomLogic_RoomPlaneParser_1.initializeFromXML(param1))
         {
            return;
         }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(UnknownVarFromRoomLogic_Boolean_1)
         {
            if(object != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc2_ = UnknownVarFromRoomLogic_RoomPlaneParser_1.getXML();
                  _loc3_.setString("room_plane_xml",_loc2_.toString());
                  _loc3_.setNumber("room_floor_hole_update_time",param1);
                  UnknownVarFromRoomLogic_RoomPlaneParser_1.initializeFromXML(_loc2_);
               }
            }
            UnknownVarFromRoomLogic_Boolean_1 = false;
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(UnknownVarFromRoomLogic_ColorTransitioner_1 && UnknownVarFromRoomLogic_ColorTransitioner_1.updateColor(param1))
         {
            _loc2_ = UnknownVarFromRoomLogic_ColorTransitioner_1.color;
            _loc3_ = object.getModel() as IRoomObjectModelController;
            if(_loc3_ == null)
            {
               return;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case "RORMUM_ADD_MASK":
               ...
               _loc3_ = UnknownVarFromRoomLogic_RoomPlaneBitmapMaskParser_1.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc7_);
               break;
            case "RORMUM_REMOVE_MASK":
               _loc3_ = UnknownVarFromRoomLogic_RoomPlaneBitmapMaskParser_1.removeMask(param1.maskId);
         }
         if(_loc3_)
         {
            _loc6_ = UnknownVarFromRoomLogic_RoomPlaneBitmapMaskParser_1.getXML();
            _loc4_ = _loc6_.toXMLString();
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         {
            case "RORPFHUM_ADD":
               UnknownVarFromRoomLogic_RoomPlaneParser_1.addFloorHole(param1.id,param1.x,param1.y,param1.width,param1.height,param1.invert);
               UnknownVarFromRoomLogic_Boolean_1 = true;
               break;
            case "RORPFHUM_REMOVE":
               UnknownVarFromRoomLogic_RoomPlaneParser_1.removeFloorHole(param1.id);
               UnknownVarFromRoomLogic_Boolean_1 = true;
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         if(UnknownVarFromRoomLogic_ColorTransitioner_1)
         {
            UnknownVarFromRoomLogic_ColorTransitioner_1.startTransition(_loc3_,_loc6_,getTimer());
         }
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         var _loc5_:IRoomObjectModelController = object.getModel() as IRoomObjectModelController;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc6_:RoomObjectRoomPlaneVisibilityUpdateMessage = param1 as RoomObjectRoomPlaneVisibilityUpdateMessage;
         if(_loc6_ != null)
         {
            updatePlaneVisibilities(_loc6_,_loc5_);
            return;
         }
         var _loc4_:RoomObjectRoomPlanePropertyUpdateMessage = param1 as RoomObjectRoomPlanePropertyUpdateMessage;
         if(_loc4_ != null)
         {
            updatePlaneProperties(_loc4_,_loc5_);
            return;
         }
         var _loc8_:RoomObjectRoomFloorHoleUpdateMessage = param1 as RoomObjectRoomFloorHoleUpdateMessage;
         if(_loc8_ != null)
         {
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         var _loc9_:IRoomObjectModelController = object.getModel() as IRoomObjectModelController;
         if(_loc9_ == null)
         {
            return;
         }
         var _loc10_:int = 0;
         var _loc11_:String = _loc7_.spriteTag;
         if(_loc11_ != null && _loc11_.indexOf("@") >= 0)
         {
            _loc10_ = parseInt(_loc11_.substr(_loc11_.indexOf("@") + 1));
         }
         if(_loc10_ < 1 || _loc10_ > UnknownVarFromRoomLogic_RoomPlaneParser_1.planeCount)
         {
         ...
         var _loc4_:IVector3d = UnknownVarFromRoomLogic_RoomPlaneParser_1.getPlaneLocation(_loc10_);
         var _loc8_:IVector3d = UnknownVarFromRoomLogic_RoomPlaneParser_1.getPlaneLeftSide(_loc10_);
         var _loc19_:IVector3d = UnknownVarFromRoomLogic_RoomPlaneParser_1.getPlaneRightSide(_loc10_);
         var _loc25_:IVector3d = UnknownVarFromRoomLogic_RoomPlaneParser_1.getPlaneNormalDirection(_loc10_);
         var _loc21_:int = UnknownVarFromRoomLogic_RoomPlaneParser_1.getPlaneType(_loc10_);
         if(_loc4_ == null || _loc8_ == null || _loc19_ == null || _loc25_ == null)
         {
            return;
         }
         var _loc22_:Number = _loc8_.length;
         var _loc5_:Number = _loc19_.length;
         ...
         _loc15_ = param2.getPlanePosition(_loc26_,_loc4_,_loc8_,_loc19_);
         if(_loc15_ == null)
         {
            _loc9_.setNumber("room_selected_plane",0);
            return;
