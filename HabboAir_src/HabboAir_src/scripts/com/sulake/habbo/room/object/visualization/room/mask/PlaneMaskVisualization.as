package com.sulake.habbo.room.object.visualization.room.mask
{
   ...
   public class PlaneMaskVisualization
   {
      ...
      private var UnknownVarFromPlaneMaskVisualization_Array_1:Array = [];
      ...
      public function dispose() : void
      {
         ...
         if(UnknownVarFromPlaneMaskVisualization_Array_1 != null)
         {
            _loc2_ = 0;
            while(_loc2_ < UnknownVarFromPlaneMaskVisualization_Array_1.length)
            {
               _loc1_ = UnknownVarFromPlaneMaskVisualization_Array_1[_loc2_] as PlaneMaskBitmap;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
            ...
            UnknownVarFromPlaneMaskVisualization_Array_1 = null;
         }
      }
      ...
      public function addBitmap(param1:IGraphicAsset, param2:Number = -1, param3:Number = 1, param4:Number = -1, param5:Number = 1) : void
      {
         ...
         UnknownVarFromPlaneMaskVisualization_Array_1.push(_loc6_);
      }
      ...
      public function getAsset(param1:IVector3d) : IGraphicAsset
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < UnknownVarFromPlaneMaskVisualization_Array_1.length)
         {
            _loc2_ = UnknownVarFromPlaneMaskVisualization_Array_1[_loc3_] as PlaneMaskBitmap;
            if(_loc2_ != null)
            {
