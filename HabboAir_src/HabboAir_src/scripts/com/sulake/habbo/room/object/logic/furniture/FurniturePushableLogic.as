package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private var UnknownVarFromFurniturePushableLogic_Vector3d_1:Vector3d = null;
      
      public function FurniturePushableLogic()
      {
         super();
         setMoveUpdateInterval(500);
         UnknownVarFromFurniturePushableLogic_Vector3d_1 = new Vector3d();
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object != null && _loc4_ == null)
         {
            if(param1.loc != null)
            {
               ...
               _loc5_ = Vector3d.dif(param1.loc,_loc3_);
               if(_loc5_ != null)
               {
         ...
         var _loc7_:RoomObjectDataUpdateMessage = param1 as RoomObjectDataUpdateMessage;
         if(_loc7_ != null)
         {
            if(_loc7_.state > 0)
            {
               setMoveUpdateInterval(_loc2_ / getUpdateIntervalValue(_loc7_.state));
            }
            else
            {
               setMoveUpdateInterval(1);
            }
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            UnknownVarFromFurniturePushableLogic_Vector3d_1.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),UnknownVarFromFurniturePushableLogic_Vector3d_1).length == 0)
            {
