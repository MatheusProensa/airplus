package com.sulake.habbo.room
{
   ...
   public interface IRoomEngine_1
   {
      ...
      function updateObjectFurnitureLocation(param1:int, param2:int, param3:IVector3d, param4:IVector3d, param5:IVector3d, param6:Number = NaN, param7:Number = NaN, param8:Number = NaN) : Boolean;
      ...
      function updateObjectUserBlocked(param1:int, param2:int, param3:Boolean) : Boolean;
