package com.sulake.habbo.room
{
   ...
   public interface IRoomEngine extends IUnknown
   {
      ...
      function updateRoomCamera(param1:int, param2:int, param3:IVector3d, param4:uint) : void;
      ...
      function getFurnitureIcon(param1:int, param2:UnknownIHabboRoom1, param3:String = null, param4:IStuffData = null, param5:Boolean = false) : UnknownHabboRoom1;
      
      function getWallItemIconUrl(param1:int, param2:String = null) : String;
      
      function getWallItemIcon(param1:int, param2:UnknownIHabboRoom1, param3:String = null) : UnknownHabboRoom1;
      
      function getFurnitureImage(param1:int, param2:IVector3d, param3:int, param4:UnknownIHabboRoom1, param5:uint = 0, param6:String = null, param7:int = -1, param8:int = -1, param9:IStuffData = null, param10:Boolean = false) : UnknownHabboRoom1;
      
      function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:UnknownIHabboRoom1, param6:uint = 0, param7:String = null, param8:IStuffData = null, param9:int = -1, param10:int = -1, param11:String = null, param12:int = -1) : UnknownHabboRoom1;
      
      function getWallItemImage(param1:int, param2:IVector3d, param3:int, param4:UnknownIHabboRoom1, param5:uint = 0, param6:String = null, param7:int = -1, param8:int = -1) : UnknownHabboRoom1;
      
      function getPetImage(param1:int, param2:int, param3:int, param4:IVector3d, param5:int, param6:UnknownIHabboRoom1, param7:Boolean = true, param8:uint = 0, param9:Array = null, param10:String = null) : UnknownHabboRoom1;
      
      function getRoomImage(param1:String, param2:String, param3:String, param4:int, param5:UnknownIHabboRoom1, param6:String = null) : UnknownHabboRoom1;
      
      function getRoomObjectImage(param1:int, param2:int, param3:int, param4:IVector3d, param5:int, param6:UnknownIHabboRoom1, param7:uint = 0) : UnknownHabboRoom1;
      ...
      function rotateActiveObjectPreview(param1:Boolean) : Boolean;
      ...
      function getObjectMoverIconSpriteVisible() : Boolean;
      ...
      function updateObjectUser(param1:int, param2:int, param3:IVector3d, param4:IVector3d, param5:Boolean = false, param6:Number = 0, param7:IVector3d = null, param8:Number = NaN, param9:Number = NaN, param10:Boolean = false, param11:Number = NaN) : Boolean;
      ...
      function setFpsCounterEnabled(param1:Boolean) : void;
      ...
      function setMouseEventsDisabledRect(param1:String, param2:Rectangle) : void;
      
      function removeMouseEventsDisabledRect(param1:String) : void;
