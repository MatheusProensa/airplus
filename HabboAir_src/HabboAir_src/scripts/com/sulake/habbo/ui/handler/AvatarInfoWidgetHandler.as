package com.sulake.habbo.ui.handler
{
   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var UnknownVarFromAvatarInfoWidgetHandler_AvatarInfoWidget_1:AvatarInfoWidget;
      
      private var UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_1:IMessageEvent;
      
      private var UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_2:IMessageEvent;
      ...
      {
         UnknownVarFromAvatarInfoWidgetHandler_AvatarInfoWidget_1 = param1;
      }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            if(UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_2 && _container.connection)
            {
               _container.connection.removeMessageEvent(UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_2);
            }
            container = null;
            UnknownVarFromAvatarInfoWidgetHandler_AvatarInfoWidget_1 = null;
            if(UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_1 != null)
            {
               UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_1.dispose();
               UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_1 = null;
            }
            UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_2 = null;
            _disposed = true;
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         {
            _container.connection.removeMessageEvent(UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_1);
         }
         if(_container && _container.connection && UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_2)
         {
            _container.connection.removeMessageEvent(UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_2);
         }
         _container = param1;
         ...
         if(UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_1 == null)
         {
            UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_1 = new FurniListAddOrUpdateEvent(onFurniListUpdated);
         }
         if(!UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_2 && _container.connection)
         {
            UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_2 = new CustomUserNotificationMessageEvent(onCustomUserNotificationMessage);
            _container.connection.addMessageEvent(UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_2);
         }
         if(_container && _container.toolbar && _container.toolbar.events)
         {
         ...
         if(_container && _container.connection)
         {
            _container.connection.addMessageEvent(UnknownVarFromAvatarInfoWidgetHandler_IMessageEvent_1);
         }
      }
      ...
      private function onToolbarClicked(param1:HabboToolbarEvent) : void
      {
         if(param1.iconId == "HTIE_ICON_MEMENU")
         {
            ...
            {
               UnknownVarFromAvatarInfoWidgetHandler_AvatarInfoWidget_1.selectOwnAvatar();
            }
            else
            {
      ...
      {
         UnknownVarFromAvatarInfoWidgetHandler_AvatarInfoWidget_1.close();
      }
      ...
      private function onPetStatusUpdate(param1:RoomSessionPetStatusUpdateEvent) : void
      {
         ...
         if(_container != null && _container.events != null)
         {
            ...
            if(_loc7_ == null)
            {
               Logger.log("Could not find pet with the id: " + param1.petId + " given by petStatusUpdate");
               return;
            }
      ...
      private function dispatchOwnAvatarInfo() : void
      {
         ...
         var _loc1_:IUserData = _container.roomSession.userDataManager.getUserData(_loc4_);
         if(_loc1_)
         {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(message.type)
         {
            ...
            case "RWUAM_REQUEST_PET_UPDATE":
               UnknownVarFromAvatarInfoWidgetHandler_AvatarInfoWidget_1.handlePetInfo = false;
               break;
            ...
            case "RWUAM_COMPOST_PLANT":
               localization = UnknownVarFromAvatarInfoWidgetHandler_AvatarInfoWidget_1.catalog.localization;
               UnknownVarFromAvatarInfoWidgetHandler_AvatarInfoWidget_1.windowManager.confirm(localization.getLocalization("monsterplant.confirm.title.compost"),localization.getLocalization("monsterplant.confirm.desc.compost"),0,(function():*
               {
                  var onCompostConfirmed:Function;
                  return onCompostConfirmed = function(param1:UnknownICoreWindowUtils2, param2:WindowEvent):void
                  {
                     param1.dispose();
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case "rsudue_user_data_updated":
               ...
               {
                  if(_container && _container.sessionDataManager && _container.roomSession && _container.roomSession.userDataManager)
                  {
                     if(_container.sessionDataManager.isBlocked(_loc3_.webID))
                     {
                        _container.roomSession.userDataManager.markAsBlocked(_loc3_.roomObjectId);
                     }
                  }
               }
            ...
            case "RSDE_DANCE":
               ...
               if(_loc2_ && UnknownVarFromAvatarInfoWidgetHandler_AvatarInfoWidget_1 && container && container.roomSession && container.roomSession.userDataManager)
               {
                  _loc4_ = container.roomSession.userDataManager.getUserData(container.sessionDataManager.userId);
                  if(_loc4_ && _loc2_.userId == _loc4_.roomObjectId)
                  {
                     UnknownVarFromAvatarInfoWidgetHandler_AvatarInfoWidget_1.isDancing = _loc2_.danceStyle != 0;
                  }
               }
               break;
      ...
      {
         Logger.log("Show breed menu. finally: " + param1);
         ...
         var _loc6_:IUserData = _container.roomSession.userDataManager.getUserDataByType(param1,2);
         if(_loc6_ == null)
         {
            return;
         }
      ...
      private function onNestBreedingSuccessEvent(param1:RoomSessionNestBreedingSuccessEvent) : void
      {
         if(_container != null && _container.events != null)
         {
            UnknownVarFromAvatarInfoWidgetHandler_AvatarInfoWidget_1.showNestBreedingSuccess(param1.petId,param1.rarityCategory);
         }
      }
      ...
      private function handleUseProductMenuRequestInventoryItem(param1:int, param2:int) : void
      {
         ...
         var _loc3_:int = _container.sessionDataManager.userId;
         var _loc5_:IFurnitureData = _container.sessionDataManager.getFloorItemData(param2);
         if(!_loc5_)
         {
            return;
         }
         var _loc4_:Array = _loc5_.customParams.split(" ");
         var _loc7_:int = _loc4_.length > 0 ? parseInt(_loc4_[0]) : -1;
         if(_loc7_ == -1)
         {
            return;
         }
      ...
      private function handleUseProductMenuRequestRoomObject(param1:int) : void
      {
         ...
         var _loc5_:IFurnitureData = getFurniData(_loc7_);
         var _loc4_:Array = _loc5_.customParams.split(" ");
         var _loc8_:int = _loc4_.length > 0 ? parseInt(_loc4_[0]) : -1;
         if(_loc8_ == -1)
         {
            return;
         }
      ...
      private function activateUseProductMenuForPets(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int = -1) : void
      {
         ...
         UnknownVarFromAvatarInfoWidgetHandler_AvatarInfoWidget_1.showUseProductMenuForItems(_loc13_);
      }
      ...
      private function activateBreedMenuForPets(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         UnknownVarFromAvatarInfoWidgetHandler_AvatarInfoWidget_1.showBreedPetMenuForItems(_loc11_);
      }
      
      private function findPetWithWebId(param1:int) : IUserData
      {
         var _loc4_:int = 0;
