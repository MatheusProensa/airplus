package com.sulake.habbo.ui.handler
{
   ...
   public class ExternalImageWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var UnknownVarFromExternalImageWidgetHandler_ExternalImageWidget_1:ExternalImageWidget;
      ...
      {
         UnknownVarFromExternalImageWidgetHandler_ExternalImageWidget_1 = param1;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         if(param1 is RoomEngineUseProductEvent)
         {
            ...
            {
               UnknownVarFromExternalImageWidgetHandler_ExternalImageWidget_1.showWithFurniID(_loc2_.objectId);
            }
         }
         ...
         switch(param1.type)
         {
            case "RETWE_OPEN_WIDGET":
               if(_loc3_ != null)
               {
                  UnknownVarFromExternalImageWidgetHandler_ExternalImageWidget_1.showWithRoomObject(_loc3_);
               }
               break;
            case "RETWE_CLOSE_WIDGET":
               UnknownVarFromExternalImageWidgetHandler_ExternalImageWidget_1.hide();
         }
      }
