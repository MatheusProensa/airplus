package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureAreaHideWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var UnknownVarFromFurnitureAreaHideWidgetHandler_AreaHideFurniWidget_1:AreaHideFurniWidget;
      ...
      {
         UnknownVarFromFurnitureAreaHideWidgetHandler_AreaHideFurniWidget_1 = param1;
      }
         ...
         switch(param1.type)
         {
            case "RETWE_REQUEST_AREA_HIDE":
               if(validateRights())
               {
                  ...
                  _loc9_ = _container.roomEngine.getRoomObject(_loc4_.roomId,_loc4_.objectId,_loc4_.category);
                  _loc13_ = _loc9_.getModel();
                  _loc11_ = Boolean(_loc9_.getState(0));
                  _loc7_ = _loc13_.getNumber("furniture_area_hide_root_x");
                  _loc8_ = _loc13_.getNumber("furniture_area_hide_root_y");
                  _loc12_ = _loc13_.getNumber("furniture_area_hide_width");
                  _loc5_ = _loc13_.getNumber("furniture_area_hide_length");
                  ...
                  UnknownVarFromFurnitureAreaHideWidgetHandler_AreaHideFurniWidget_1.open(_loc9_.getId(),_loc11_,_loc7_,_loc8_,_loc12_,_loc5_,_loc2_,_loc10_,_loc3_);
               }
               break;
            case "RETWE_UPDATE_STATE_AREA_HIDE":
               _loc6_ = param1 as RoomEngineAreaHideStateWidgetEvent;
               UnknownVarFromFurnitureAreaHideWidgetHandler_AreaHideFurniWidget_1.updateStatus(_loc6_.objectId,_loc6_.isOn);
         }
      }
