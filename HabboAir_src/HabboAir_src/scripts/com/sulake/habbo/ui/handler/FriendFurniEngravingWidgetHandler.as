package com.sulake.habbo.ui.handler
{
   ...
   public class FriendFurniEngravingWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var UnknownVarFromFriendFurniEngravingWidgetHandler_FriendFurniEngravingWidget_1:FriendFurniEngravingWidget = null;
      
      public function FriendFurniEngravingWidgetHandler()
      {
         super();
      }
      ...
      {
         UnknownVarFromFriendFurniEngravingWidgetHandler_FriendFurniEngravingWidget_1 = param1;
      }
      ...
      public function dispose() : void
      {
         _disposed = true;
         _container = null;
         UnknownVarFromFriendFurniEngravingWidgetHandler_FriendFurniEngravingWidget_1 = null;
      }
         ...
         if("RETWE_REQUEST_FRIEND_FURNITURE_ENGRAVING" === _loc6_)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  UnknownVarFromFriendFurniEngravingWidgetHandler_FriendFurniEngravingWidget_1.open(_loc2_.getId(),_loc5_.getNumber("furniture_friendfurni_engraving_type"),_loc3_);
               }
            }
         }
      }
