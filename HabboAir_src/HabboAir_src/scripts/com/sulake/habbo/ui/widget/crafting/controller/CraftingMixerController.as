package com.sulake.habbo.ui.widget.crafting.controller
{
   ...
   public class CraftingMixerController extends CraftingGridControllerBase
   {
      ...
      public function returnItemsToInventory() : void
      {
         ...
         if(UnknownVarFromCraftingGridControllerBase_CraftingWidget_1 && UnknownVarFromCraftingGridControllerBase_CraftingWidget_1.inventoryCtrl)
         {
            UnknownVarFromCraftingGridControllerBase_CraftingWidget_1.inventoryCtrl.updateItemCounts();
         }
      }
      ...
      public function addItemToMixer(param1:CraftingFurnitureItem, param2:int) : Boolean
      {
         ...
         var _loc3_:IWindowController_1 = getItemTemplate();
         var _loc4_:CraftingMixerItemRenderer = new CraftingMixerItemRenderer(param1,_loc3_.clone() as IWindowController_1,UnknownVarFromCraftingGridControllerBase_CraftingWidget_1);
         _loc4_.inventoryId = param2;
         container.addGridItem(_loc4_.window);
         _renderers.push(_loc4_);
         if(UnknownVarFromCraftingGridControllerBase_CraftingWidget_1.inSecretRecipeMode)
         {
            UnknownVarFromCraftingGridControllerBase_CraftingWidget_1.mixerContentChanged(collectSelectedFurnitureIds());
         }
         return true;
      }
