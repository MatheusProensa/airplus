   ...
   public class BotChangeNameConfiguration extends BotSkillConfigurationViewBase
   {
      ...
      private function procedure(param1:WindowEvent, param2:IWindowModel) : void
      {
         if(param1.type == "WME_CLICK")
         {
            ...
            {
               case "save_button":
                  UnknownVarFromBotSkillConfigurationViewBase_AvatarInfoWidget_1.handler.container.connection.send(new CommandBotComposer(UnknownVarFromBotSkillConfigurationViewBase_Int_1,5,_newName));
                  close();
                  break;
               case "cancel_button":
                  close();
