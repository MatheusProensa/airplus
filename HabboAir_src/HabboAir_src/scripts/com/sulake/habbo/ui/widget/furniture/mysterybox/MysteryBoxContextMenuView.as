package com.sulake.habbo.ui.widget.furniture.mysterybox
{
   ...
   public class MysteryBoxContextMenuView extends FurnitureContextInfoView
   {
      ...
      public function MysteryBoxContextMenuView(param1:UnknownIHabboUiWidgetContextmenu1)
      {
         super(param1);
      }
      ...
      override protected function updateWindow() : void
      {
         ...
         else
         {
            ...
            {
               _loc1_ = UnknownVarFromContextInfoView_UnknownIHabboUiWidgetContextmenu1_1.assets.getAssetByName("mysterybox_menu").content as XML;
      ...
      private function refreshOwnerMode() : void
      {
         ...
         _window.findChildByName("label").caption = "${mysterybox.context." + (_isOwnerMode ? "owner" : "other") + ".use}";
      }
         ...
         if(param1.type == "WME_CLICK")
         {
            if(param2.name == "button")
            {
               ...
               if("use" === _loc5_)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc4_.showMysteryBoxOpenDialog(_roomObject);
                  }
               }
            }
            _loc3_ = true;
