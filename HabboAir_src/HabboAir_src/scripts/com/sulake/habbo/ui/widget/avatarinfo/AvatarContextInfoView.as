package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarContextInfoView extends ContextInfoView
   {
      ...
      protected var UnknownVarFromAvatarContextInfoView_Boolean_1:Boolean;
      
      public function AvatarContextInfoView(param1:UnknownIHabboUiWidgetContextmenu1)
      {
         super(param1);
         UnknownVarFromContextInfoView_UnknownIHabboUiWidgetContextmenu1_1 = param1 as AvatarInfoWidget;
      }
      
      public static function setup(param1:AvatarContextInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false, param7:Boolean = false) : void
      {
         ...
         param1.UnknownVarFromAvatarContextInfoView_Boolean_1 = param7;
         setupContext(param1);
      }
      ...
      override protected function updateWindow() : void
      {
         ...
         if(UnknownVarFromAvatarContextInfoView_Boolean_1)
         {
            _loc2_.italic = true;
