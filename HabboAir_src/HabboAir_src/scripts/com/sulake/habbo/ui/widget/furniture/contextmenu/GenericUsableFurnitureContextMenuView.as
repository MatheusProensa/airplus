package com.sulake.habbo.ui.widget.furniture.contextmenu
{
   ...
   {
      private var UnknownVarFromGenericUsableFurnitureContextMenuView_Int_1:int;
      
      public function GenericUsableFurnitureContextMenuView(param1:UnknownIHabboUiWidgetContextmenu1)
      {
         super(param1);
      }
      ...
      override protected function updateWindow() : void
      {
         ...
         else
         {
            if(!_window)
            {
               _loc1_ = XmlAsset(UnknownVarFromContextInfoView_UnknownIHabboUiWidgetContextmenu1_1.assets.getAssetByName("generic_usable_menu")).content as XML;
      ...
      override protected function buttonEventProc(param1:WindowEvent, param2:IWindowModel) : void
      {
         ...
         if(param1.type == "WME_CLICK")
         {
            if(param2.name == "button")
            {
               ...
               if("use" === _loc4_)
               {
                  UnknownVarFromContextInfoView_UnknownIHabboUiWidgetContextmenu1_1.messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage("RWFAM_USE",_roomObject.getId(),UnknownVarFromGenericUsableFurnitureContextMenuView_Int_1));
               }
            }
            _loc3_ = true;
         }
      ...
      {
         UnknownVarFromGenericUsableFurnitureContextMenuView_Int_1 = param1;
      }
   }
}
