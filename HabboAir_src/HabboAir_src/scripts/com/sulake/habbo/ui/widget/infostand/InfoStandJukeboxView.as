package com.sulake.habbo.ui.widget.infostand
{
   ...
   {
      private var UnknownVarFromInfoStandJukeboxView_Int_1:int = -1;
      
      private var _songName:String = "";
      
      private var UnknownVarFromInfoStandJukeboxView_String_1:String = "";
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var _loc4_:XmlAsset = UnknownVarFromInfoStandFurniView_InfoStandWidget_1.assets.getAssetByName("jukebox_view") as XmlAsset;
      ...
      public function updateSongInfo(param1:RoomWidgetSongUpdateEvent) : void
      {
         ...
         {
            UnknownVarFromInfoStandJukeboxView_Int_1 = param1.songId;
         }
         if(param1.songId == UnknownVarFromInfoStandJukeboxView_Int_1)
         {
            _songName = param1.songName;
            UnknownVarFromInfoStandJukeboxView_String_1 = param1.songAuthor;
            updateNowPlaying(UnknownVarFromInfoStandJukeboxView_Int_1 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         var _loc3_:ITextWindow = UnknownVarFromInfoStandFurniView_IItemListWindow_2.getListItemByName("now_playing_text") as ITextWindow;
         if(_loc3_ != null)
         {
            if(param1)
            {
               _loc2_ = UnknownVarFromInfoStandFurniView_InfoStandWidget_1.localizations.getLocalization("infostand.jukebox.text.now.playing");
            }
            else
            {
               _loc2_ = UnknownVarFromInfoStandFurniView_InfoStandWidget_1.localizations.getLocalization("infostand.jukebox.text.not.playing");
            }
            _loc3_.text = _loc2_;
         }
         if(param1)
         {
            ...
            nowPlayingAuthorName = UnknownVarFromInfoStandJukeboxView_String_1;
         }
         else
         {
            nowPlayingTrackName = "";
