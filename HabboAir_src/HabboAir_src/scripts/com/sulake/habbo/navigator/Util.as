package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      public static function getLocationRelativeTo(param1:IWindowModel, param2:int, param3:int) : Rectangle
      {
         if(param1 == null)
         {
      ...
      public static function hasVisibleChildren(param1:IWindowController_1) : Boolean
      {
         var _loc2_:int = 0;
      ...
      public static function moveChildrenToRow(param1:IWindowController_1, param2:Array, param3:int, param4:int, param5:int) : void
      {
      ...
      public static function layoutChildrenInArea(param1:IWindowController_1, param2:int, param3:int, param4:int = 0, param5:int = 0) : void
      {
         var _loc8_:int = 0;
      ...
      public static function setProc(param1:IWindowController_1, param2:String, param3:Function) : void
      {
         var _loc4_:IWindowModel = param1.findChildByName(param2);
         _loc4_.setParamFlag(1,true);
      ...
      public static function binarySearch(param1:ICutToHeight, param2:int) : void
      {
         var _loc5_:int = 0;
      ...
      public static function containsMouse(param1:IWindowModel) : Boolean
      {
