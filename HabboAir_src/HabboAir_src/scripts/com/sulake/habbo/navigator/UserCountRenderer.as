package com.sulake.habbo.navigator
{
   ...
   public class UserCountRenderer
   {
      ...
      public function UserCountRenderer(param1:IHabboNavigator_2)
      {
         super();
         _navigator = param1;
      }
      ...
      public function refreshUserCount(param1:int, param2:IWindowController_1, param3:int, param4:String, param5:int, param6:int) : void
      {
         var _loc9_:IWindowController_1 = IWindowController_1(param2.findChildByName("usercount"));
         if(_loc9_ == null)
         {
            _loc9_ = IWindowController_1(_navigator.getXmlWindow("grs_usercount"));
            _loc9_.name = "usercount";
            _loc9_.x = param5;
            _loc9_.y = param6;
            param2.addChild(_loc9_);
         }
         IInteractiveWindow(_loc9_).toolTipCaption = param4;
         var _loc7_:ITextWindow = ITextWindow(_loc9_.findChildByName("txt"));
         _loc7_.text = "" + param3;
      ...
      private function refreshBg(param1:IWindowController_1, param2:String) : void
      {
         var _loc3_:String = null;
         var _loc4_:IBitmapWrapperController = IBitmapWrapperController(param1.findChildByName("usercount_bg"));
         if(_loc4_.tags[0] != param2)
         {
      ...
      private function refreshIcon(param1:IWindowController_1, param2:String, param3:Boolean) : void
      {
