package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventInfoCtrl implements IComponentInterfaceQueue
   {
      ...
      public function RoomEventInfoCtrl(param1:IHabboNavigator_2)
      {
         super();
         _navigator = param1;
      }
      ...
      public function refresh() : void
      {
         ...
         var _loc11_:IRoomSession = _navigator.roomSessionManager.getSession(_loc10_);
         if(!_loc11_)
         {
            return;
         }
      ...
      private function canExtend() : Boolean
      {
         ...
         var _loc1_:Number = Number(_loc5_.getTime());
      ...
      private function prepareWindow() : void
      {
         ...
         _window = IWindowController_1(_navigator.getXmlWindow("iro_event_info"));
      ...
      private function onModify(param1:WindowEvent, param2:IWindowModel) : void
      {
      ...
      private function onExtend(param1:WindowEvent, param2:IWindowModel) : void
      {
         var _loc3_:RoomEventData = null;
         if(param1.type == "WME_CLICK")
         {
