package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomInfoViewCtrl
   {
      ...
      private var UnknownVarFromRoomInfoViewCtrl_GuildInfoCtrl_1:GuildInfoCtrl;
      
      private var _window:IFrameController;
      
      private var UnknownVarFromRoomInfoViewCtrl_TagRenderer_1:TagRenderer;
      
      private var _embedExpanded:Boolean = false;
      
      private var UnknownVarFromRoomInfoViewCtrl_Boolean_1:Boolean = false;
      
      public function RoomInfoViewCtrl(param1:IHabboNavigator_2)
      {
         super();
         _navigator = param1;
         UnknownVarFromRoomInfoViewCtrl_GuildInfoCtrl_1 = new GuildInfoCtrl(_navigator);
         UnknownVarFromRoomInfoViewCtrl_TagRenderer_1 = new TagRenderer(_navigator);
      }
      
      public function dispose() : void
      {
         _navigator = null;
         UnknownVarFromRoomInfoViewCtrl_Boolean_1 = false;
         if(_window)
         {
            _window.dispose();
            _window = null;
         }
         if(UnknownVarFromRoomInfoViewCtrl_TagRenderer_1)
         {
            UnknownVarFromRoomInfoViewCtrl_TagRenderer_1.dispose();
            UnknownVarFromRoomInfoViewCtrl_TagRenderer_1 = null;
         }
         if(UnknownVarFromRoomInfoViewCtrl_GuildInfoCtrl_1)
         {
            UnknownVarFromRoomInfoViewCtrl_GuildInfoCtrl_1.dispose();
            UnknownVarFromRoomInfoViewCtrl_GuildInfoCtrl_1 = null;
         }
      }
      ...
      {
         if(UnknownVarFromRoomInfoViewCtrl_Boolean_1)
         {
            refresh();
         }
      }
      ...
      public function toggle() : void
      {
         ...
         {
            UnknownVarFromRoomInfoViewCtrl_Boolean_1 = true;
            refresh();
            if(_window != null)
            {
               _window.activate();
      ...
      private function refresh() : void
      {
         ...
         UnknownVarFromRoomInfoViewCtrl_TagRenderer_1.useHashTags = true;
         prepareWindow();
         Util.hideChildren(_window.content);
         refreshRoomDetails(_navigator.data.enteredGuestRoom);
         refreshEmbed();
         UnknownVarFromRoomInfoViewCtrl_GuildInfoCtrl_1.refresh(_window.content,_navigator.data.enteredGuestRoom);
      ...
      private function refreshEmbed() : void
      {
         ...
         var _loc1_:IWindowController_1 = IWindowController_1(find("embed_info"));
      ...
      private function refreshRoomDetails(param1:GuestRoomData) : void
      {
         if(param1 == null)
         {
            return;
         }
         var _loc4_:IWindowController_1 = IWindowController_1(find("room_details"));
         var _loc6_:ITextWindow = ITextWindow(find("room_name"));
         _loc6_.text = param1.roomName;
         ...
         UnknownVarFromRoomInfoViewCtrl_TagRenderer_1.refreshTags(_loc4_,param1.tags);
         _loc3_.visible = false;
         ...
         var _loc5_:IWindowModel = _window.findChildByName("rating_txt");
      ...
      public function refreshButtons(param1:GuestRoomData) : void
      {
         ...
         {
            _loc3_ = IWindowController_1(find("room_report_button"));
            if(_loc3_)
            {
               _loc3_.visible = false;
            }
         ...
         refreshStaffPick();
         var _loc6_:IWindowModel = find("room_muteall_button");
         _loc6_.visible = _navigator.data.enteredGuestRoom.canMute && _navigator.getBoolean("room_moderation.mute_all.enabled");
         ...
         var _loc4_:IWindowController_1 = IWindowController_1(_window.findChildByName("buttons_cont"));
         ...
         _loc4_.visible = Util.hasVisibleChildren(IWindowController_1(_loc4_));
         _loc4_.height = Util.getLowestPoint(_loc4_);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         _window = IFrameController(_navigator.getXmlWindow("iro_room_details_framed"));
         _window.center();
         ...
         _navigator.refreshButton(IWindowController_1(find("embed_info")),"icon_weblink",true,null,0);
         addMouseClickListener(_window.findChildByTag("close"),onCloseButtonClick);
         var _loc2_:IWindowController_1 = IWindowController_1(_window.findChildByName("owner_name_cont"));
         ...
         var _loc4_:IWindowController_1 = IWindowController_1(find("embed_info"));
      ...
      {
         var _loc4_:IWindowController_1 = IWindowController_1(find(param1));
      ...
      private function onEmbedInfo(param1:WindowEvent, param2:IWindowModel) : void
      {
