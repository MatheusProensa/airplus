package com.sulake.habbo.notifications.feed.view.content
{
   ...
   public class EntityFactory
   {
      ...
      public function createNotificationEntity(param1:GenericNotificationItemData) : IFeedEntity
      {
      ...
      private function createGenericFeedEntity(param1:GenericNotificationItemData) : IFeedEntity
      {
