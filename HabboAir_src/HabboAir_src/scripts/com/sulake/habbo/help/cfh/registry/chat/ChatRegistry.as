package com.sulake.habbo.help.cfh.registry.chat
{
   public class ChatRegistry
   {
      ...
      private var UnknownVarFromChatRegistry_Uint_1:uint = 0;
      ...
      {
         _registry.push(new ChatRegistryItem(UnknownVarFromChatRegistry_Uint_1++,param1,param2,param3,param4,param5));
         purgeRegistry();
      }
      ...
      private function purgeRegistry() : void
      {
         ...
         {
            _loc4_ = new Date().time - _registry[_loc3_].chatTime.time;
            _loc2_ = _loc4_ / 65500;
            if(_loc2_ <= 15)
            {
