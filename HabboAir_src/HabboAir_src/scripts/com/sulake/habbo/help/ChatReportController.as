package com.sulake.habbo.help
{
   ...
   public class ChatReportController implements IComponentInterfaceQueue
   {
      ...
      private var UnknownVarFromChatReportController_Function_1:Function;
      
      private var _reportedRoomId:int;
      
      private var UnknownVarFromChatReportController_Int_1:int;
      ...
      public function ChatReportController(param1:HabboHelp, param2:Function)
      {
         super();
         _habboHelp = param1;
         UnknownVarFromChatReportController_Function_1 = param2;
      }
      ...
      {
         _window = _habboHelp.getXmlWindow("chat_report") as IWindowController_1;
         _window.procedure = UnknownVarFromChatReportController_Function_1;
         _window.center();
         UnknownVarFromChatReportController_Int_1 = param2;
         _reportedRoomId = -1;
         if(param3 == 3)
         {
      ...
      public function collectSelectedEntries(param1:int, param2:int) : Array
      {
         ...
         if(param1 == 3)
         {
            _loc6_ = param2 > 0 ? param2 : UnknownVarFromChatReportController_Int_1;
      ...
      private function populateInstantMessageList(param1:int, param2:int) : void
      {
         ...
         var _loc3_:IWindowController_1 = _loc8_.getListItemAt(0) as IWindowController_1;
         var _loc5_:IWindowController_1 = _habboHelp.getXmlWindow("chat_report_item") as IWindowController_1;
         _loc8_.removeListItems();
         var _loc6_:IWindowController_1 = _loc3_.clone() as IWindowController_1;
         ...
         {
            _loc4_ = _loc5_.clone() as IWindowController_1;
         ...
         for each(var _loc12_ in _loc10_)
         {
            if(_loc12_.userId != param1)
            {
               if(_loc12_.roomId != _loc9_)
               {
                  ...
                  _loc6_ = _loc3_.clone() as IWindowController_1;
                  _loc6_.findChildByName("room_name").caption = "Room: " + _loc12_.roomName;
                  _loc8_.addListItemAt(_loc6_,0);
                  _loc11_ = _loc6_.findChildByName("chat_items") as IItemListWindow;
      ...
      private function onChatEntryEvent(param1:WindowEvent, param2:IWindowModel) : void
      {
         ...
         if(param1.type == "WME_CLICK")
         {
            ...
            if(!_loc3_.selected && _loc3_.roomId != _reportedRoomId)
            {
               _reportedRoomId = _loc3_.roomId;
               deselectChatEntries();
            }
      ...
      private function onInstantMessageEntryEvent(param1:WindowEvent, param2:IWindowModel) : void
      {
         ...
         if(param1.type == "WME_CLICK")
         {
            _loc3_ = _habboHelp.instantMessageRegistry.getItem(UnknownVarFromChatReportController_Int_1,param2.id);
            if(!_loc3_)
            {
               return;
            }
      ...
      private function refreshChatEntries() : void
      {
         ...
         {
            _loc2_ = _loc5_.getListItemAt(_loc3_) as IWindowController_1;
            _loc6_ = _loc2_.findChildByName("chat_items") as IItemListWindow;
            _loc4_ = 0;
            while(_loc4_ < _loc6_.numListItems)
            {
               _loc1_ = _loc6_.getListItemAt(_loc4_) as IWindowModel;
      ...
      public function refreshInstantMessageEntries() : void
      {
         ...
         while(_loc3_ < _loc5_.numListItems)
         {
            ...
            {
               _loc1_ = _loc6_.getListItemAt(_loc4_) as IWindowModel;
               _loc7_ = _habboHelp.instantMessageRegistry.getItem(UnknownVarFromChatReportController_Int_1,_loc1_.id);
               if(_loc7_)
               {
                  _loc1_.color = _loc7_.selected ? 4282169599 : 4293848814;
               }
