package com.sulake.habbo.help
{
   ...
   public class ChatReviewReporterFeedbackCtrl implements IComponentInterfaceQueue
   {
      ...
      private function prepare() : void
      {
         ...
         _window = IFrameController(_habboHelp.getXmlWindow("chat_review_reporter_feedback"));
