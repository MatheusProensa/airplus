package com.sulake.habbo.help.namechange
{
   ...
   public class NameSuggestionListRenderer
   {
      ...
      private var UnknownVarFromNameSuggestionListRenderer_Rectangle_1:Rectangle = null;
      
      private var UnknownVarFromNameSuggestionListRenderer_Int_1:int = 0;
      ...
      public function render(param1:Array, param2:IWindowController_1) : int
      {
         ...
         UnknownVarFromNameSuggestionListRenderer_Int_1 = 0;
         _offsetX = 0;
         _offsetY = 0;
         UnknownVarFromNameSuggestionListRenderer_Rectangle_1 = param2.rectangle;
         UnknownVarFromNameSuggestionListRenderer_Rectangle_1.height = 150;
         _loc5_ = 0;
      ...
      {
         if(param1.width > UnknownVarFromNameSuggestionListRenderer_Rectangle_1.width || param1.width < 2)
         {
            return false;
         }
         if(_offsetY + param1.height > UnknownVarFromNameSuggestionListRenderer_Rectangle_1.height)
         {
            return false;
         }
         if(_offsetX + param1.width > UnknownVarFromNameSuggestionListRenderer_Rectangle_1.width)
         {
            _offsetX = 0;
      ...
      {
         var _loc2_:ITextWindow = _main.buildXmlWindow("welcome_name_suggestion_item") as ITextWindow;
         if(_loc2_ == null)
         {
            return null;
         }
