package com.sulake.habbo.phonenumber
{
   ...
   public class VerificationCodeInputMinimizedView
   {
      ...
      private var UnknownVarFromVerificationCodeInputMinimizedView_HabboPhoneNumber_1:HabboPhoneNumber;
      ...
      {
         super();
         UnknownVarFromVerificationCodeInputMinimizedView_HabboPhoneNumber_1 = param1;
         createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         UnknownVarFromVerificationCodeInputMinimizedView_HabboPhoneNumber_1 = null;
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = UnknownVarFromVerificationCodeInputMinimizedView_HabboPhoneNumber_1.windowManager.buildFromXML(XML(UnknownVarFromVerificationCodeInputMinimizedView_HabboPhoneNumber_1.assets.getAssetByName("phonenumber_verify_minimized_xml").content));
      ...
      {
         UnknownVarFromVerificationCodeInputMinimizedView_HabboPhoneNumber_1.setVerifyViewMinimized(false);
      }
