package com.sulake.habbo.campaign.calendar
{
   ...
   public class CalendarSpinnerUtil
   {
      ...
      {
         var _loc6_:IBitmapWrapperController = param1.window.findChildByName("gradient1") as IBitmapWrapperController;
         ...
         _loc6_ = param1.window.findChildByName("gradient2") as IBitmapWrapperController;
