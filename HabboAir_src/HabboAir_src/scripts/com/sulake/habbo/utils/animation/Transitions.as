package com.sulake.habbo.utils.animation
{
   ...
   public class Transitions
   {
      ...
      public static const UnknownConstFromTransitions_String_1:String = "easeOut";
      
      public static const UnknownConstFromTransitions_String_2:String = "easeInOut";
      ...
      public static const UnknownConstFromTransitions_String_3:String = "easeInElastic";
      
      public static const UnknownConstFromTransitions_String_4:String = "easeOutElastic";
      
      public static const UnknownConstFromTransitions_String_5:String = "easeInOutElastic";
      
      public static const UnknownConstFromTransitions_String_6:String = "easeOutInElastic";
      
      public static const UnknownConstFromTransitions_String_7:String = "easeInBounce";
      
      public static const UnknownConstFromTransitions_String_8:String = "easeOutBounce";
      
      public static const UnknownConstFromTransitions_String_9:String = "easeInOutBounce";
      
      public static const UnknownConstFromTransitions_String_10:String = "easeOutInBounce";
      
      private static var UnknownVarFromTransitions_Dictionary_1:Dictionary;
      ...
      {
         if(UnknownVarFromTransitions_Dictionary_1 == null)
         {
            registerDefaults();
         }
         return UnknownVarFromTransitions_Dictionary_1[param1];
      }
      ...
      public static function register(param1:String, param2:Function) : void
      {
         ...
         UnknownVarFromTransitions_Dictionary_1[param1] = param2;
      }
      
      private static function registerDefaults() : void
      {
         UnknownVarFromTransitions_Dictionary_1 = new Dictionary();
      ...
      {
         var _loc4_:Number = NaN;
         var _loc3_:Number = 7.5625;
         var _loc2_:Number = 2.75;
         if(param1 < 1 / _loc2_)
         {
