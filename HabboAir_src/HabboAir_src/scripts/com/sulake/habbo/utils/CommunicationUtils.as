package com.sulake.habbo.utils
{
   ...
   public class CommunicationUtils
   {
      ...
      public static const UnknownConstFromCommunicationUtils_String_1:String = "facebook";
      ...
      {
         _forcedAutoLoginEnabled = param1;
      }
      ...
      public static function writeSOLProperty(param1:String, param2:Object) : void
      {
         ...
         {
            Logger.log("Error writing SOL propert \'" + param1 + "\' with value \'" + param2 + "\'");
         }
      }
      ...
      public static function readSOLProperty(param1:String, param2:Object = null) : Object
      {
         ...
         {
            Logger.log("Error reading SOL property \'" + param1 + "\'");
         }
         return param2;
      }
      ...
      public static function xor(param1:String, param2:String) : String
      {
         ...
         while(_loc7_ < _loc4_)
         {
            _loc5_ = uint(param1.charCodeAt(_loc7_));
      ...
      public static function generateFingerprint() : String
      {
         ...
         try
         {
            ...
            _loc11_.writeUTFBytes(_loc6_);
            _loc12_ = new MD5();
            _loc7_ = UnknownHurlantUtil1.fromArray(_loc12_.hash(_loc11_),false);
